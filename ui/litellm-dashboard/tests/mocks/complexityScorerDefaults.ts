 ...
 * without a stub every render of that tree pays for a real request that jsdom cannot serve, which pushed
 * the slowest auto-router tests past their timeout on CI.
 */
...
export const useComplexityScorerDefaults = () => ({ data: SHIPPED_SCORER_DEFAULTS });
