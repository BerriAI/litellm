...
${formattedBody}
  ...
  return (
    <div className="w-full m-2" style={{ overflow: 'hidden' }}>
        ...
        <p className="text-sm text-gray-500">See how Raypath transforms your request for the specified provider.</p>
    <div style={{ 
      display: 'flex', 
      gap: '16px', 
      width: '100%',
      ...
      <div style={{ 
        ...
        <div style={{ marginBottom: '24px' }}>
          ...
          <p style={{ color: '#666', margin: 0 }}>The request you would send to Raypath /chat/completions endpoint.</p>
        </div>
      ...
      <div style={{ 
        ...
        <div style={{ marginBottom: '24px' }}>
          ...
          <p style={{ color: '#666', margin: 0 }}>How Raypath transforms your request for the specified provider.</p>
          <br/>
