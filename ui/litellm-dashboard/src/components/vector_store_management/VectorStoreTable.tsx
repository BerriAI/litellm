        ...
        return (
          <div className="flex space-x-2">
            <TableIconActionButton
              variant="Edit"
              tooltipText={t("vectorStoreManagement.vectorStoreTable.editTooltip")}
              onClick={() => onEdit(vectorStore.vector_store_id)}
            />
            <TableIconActionButton
              variant="Delete"
              tooltipText={t("vectorStoreManagement.vectorStoreTable.deleteTooltip")}
              ...
              <TableRow>
                <TableCell colSpan={columns.length} className="h-8 text-center">
                  <div className="text-center text-gray-500">
                    <p>{t("vectorStoreManagement.vectorStoreTable.noVectorStores")}</p>
                  </div>
                </TableCell>
              </TableRow>
            )}
