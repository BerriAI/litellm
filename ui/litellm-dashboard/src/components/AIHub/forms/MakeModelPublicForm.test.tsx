...
describe("MakeModelPublicForm", () => {
  ...
  it("should allow proceeding with no models selected to make all private", async () => {
    render(<MakeModelPublicForm {...mockProps} />);
    ...
    await waitFor(() => {
      expect(screen.getByText("Confirm Making All Models Private")).toBeInTheDocument();
    });
