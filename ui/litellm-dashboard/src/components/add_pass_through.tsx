        ...
        <Modal
          title={
            <div className="flex items-center space-x-3 border-b border-border pb-4">
              ...
              <h2 className="text-xl font-semibold text-foreground">Add Pass-Through Endpoint</h2>
            </div>
          }
          open={isModalVisible}
          width={1000}
            ...
            <form onSubmit={form.handleSubmit(addPassThrough)} className="space-y-6">
              ...
              <Card className="block p-6">
                ...
                <FormField
                  ...
                  label={labelWithHint("Cost Per Request (USD)", "Optional: Track costs for requests to this endpoint")}
