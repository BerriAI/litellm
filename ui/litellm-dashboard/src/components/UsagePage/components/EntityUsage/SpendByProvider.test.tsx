...
describe("SpendByProvider", () => {
  ...
  it("should render", () => {
    render(<SpendByProvider providerSpend={[]} />);
  ...
  it("should display table headers", () => {
    render(<SpendByProvider providerSpend={mockProviderSpend} />);
  ...
  it("should always display data (loading handled by parent LoadingOverlay)", () => {
    render(<SpendByProvider providerSpend={mockProviderSpend} />);
    expect(screen.getByText("Provider")).toBeInTheDocument();
    expect(screen.getByText("$150.50")).toBeInTheDocument();
  });
  ...
  it("should handle provider with null provider name", () => {
    ...
    render(<SpendByProvider providerSpend={providerSpendWithNull} />);
  ...
  it("should handle provider with empty string provider name", () => {
    ...
    render(<SpendByProvider providerSpend={providerSpendWithEmpty} />);
    expect(screen.getByText("$100.00")).toBeInTheDocument();
  });
  ...
  it("should display large token numbers with comma formatting", () => {
    ...
    render(<SpendByProvider providerSpend={providerSpendWithLargeTokens} />);
  ...
  it("should include all providers with spend greater than zero by default", () => {
    ...
    render(<SpendByProvider providerSpend={providerSpendWithMixed} />);
