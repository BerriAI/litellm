  ...
  const errorStats = useMemo(() => {
    ...
    return Object.entries(totals)
      .map(([name, value]) => ({
        name,
        value,
        color: selectedCategories.length === 0 || selectedCategories.includes(name) ? categoryColors[name] : "gray",
      }))
      ...
      {chartData.length > 0 && (
        <div className="mt-8 border-t pt-6">
          ...
          <AreaChart
            ...
            colors={(selectedCategories.length > 0 ? selectedCategories : errorCategories).map(
