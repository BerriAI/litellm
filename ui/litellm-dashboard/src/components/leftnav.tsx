  ...
  const menuGroups: MenuGroup[] = [
    {
      ...
      items: [
        ...
        },
        {
          key: "agents",
          page: "agents",
          label: <span className="flex items-center gap-4">Агенты</span>,
          icon: <RobotOutlined />,
          roles: rolesWithWriteAccess,
        },
        {
      ...
      items: [
        {
          key: "settings",
          page: "settings",
          label: <span className="flex items-center gap-4">Настройки</span>,
