  ...
  return (
    <>
      <Form.Item
        ...
        className="mb-0"
      >
        <Form.Item name="model" rules={[{ required: true, message: "Please select at least one model." }]} noStyle>
            ...
            return (
              modelArray.includes("custom") && (
                <Form.Item
                  ...
                  className="mt-2"
                >
                  <TextInput placeholder="Enter custom model name" onChange={handleCustomModelNameChange} />
                </Form.Item>
              )
            )
          }}
