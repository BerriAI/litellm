...
export const PARTNER_GUARDRAIL_CARDS: GuardrailCardInfo[] = [
  ...
  },
  {
    ...
    description:
      "AI firewall for detecting prompt injection, jailbreaks, and unsafe agent behavior before they affect LLM applications.",
    category: "partner",
    logo: `${ASSET_PREFIX}silmaril.png`,
    tags: ["Security", "Prompt Injection", "Jailbreaks"],
    providerKey: "Silmaril",
  },
];
