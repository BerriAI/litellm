    ...
    <div className="space-y-3">
      <div className="flex items-center gap-2">
        ...
        <Badge color={blocksAllMcpServers ? "red" : "blue"} size="xs">
          {blocksAllMcpServers ? t("permissions.mcpServerPermissions.blocked") : totalCount}
        </Badge>
      </div>
      ...
      {blocksAllMcpServers ? (
        <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-red-50 border border-red-200">
          ...
          <Text className="text-red-700 text-sm">{t("permissions.mcpServerPermissions.allServersBlocked")}</Text>
        </div>
      ) : totalCount > 0 ? (
