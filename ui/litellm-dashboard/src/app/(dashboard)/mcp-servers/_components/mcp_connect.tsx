...
--data '{
  ...
  return (
    <div>
      <Space direction="vertical" size="large" className="w-full">
        <div>
          <TremorTitle className="text-3xl font-bold text-foreground mb-3">Connect to your MCP client</TremorTitle>
          <TremorText className="text-lg text-muted-foreground">
