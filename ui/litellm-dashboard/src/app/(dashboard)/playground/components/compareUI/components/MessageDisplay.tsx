          ...
          <div key={blockIndex} className="space-y-4">
            {block.user && (
              <div className="space-y-2 min-w-0">
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-sm font-semibold text-gray-700">{t("playground.compare.you")}</div>
                </div>
            ...
            {assistantMessage ? (
              ...
              <div className="flex items-center gap-2 text-sm text-gray-500">
                ...
                <span>{t("playground.compare.generatingResponse")}</span>
              </div>
            ) : (
              <div className="text-sm text-gray-500">{t("playground.compare.waitingForResponse")}</div>
            )}
          </div>
        );
      })}
