      ...
      <div className="bg-white dark:bg-zinc-900 rounded-lg shadow-xl w-full max-w-2xl min-h-[380px] py-6 overflow-hidden transform transition-all flex flex-col justify-between">
        ...
        <div className="px-6 py-4 bg-gray-50 dark:bg-zinc-800 flex justify-end gap-4">
          ...
          <button
            onClick={onConfirm}
            disabled={!isValid}
            className={`px-5 py-3 rounded-md text-base font-medium text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 ${isValid ? "bg-red-600 hover:bg-red-700" : "bg-red-300 dark:bg-red-900/50 cursor-not-allowed"}`}
          >
            Force Delete
          </button>
        </div>
