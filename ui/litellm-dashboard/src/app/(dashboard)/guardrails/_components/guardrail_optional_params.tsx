    ...
    <div className="space-y-3">
          ...
          <div className="flex-1">
            ...
            >
              {field.dict_value_type === "number" ? (
                ...
                <Select placeholder={t("guardrailsPage.optionalParams.selectValue", { key: entry.key })}>
                ...
                <Input placeholder={t("guardrailsPage.optionalParams.enterValue", { key: entry.key })} />
              )}
            </Form.Item>
          </div>
      ...
      {availableKeys.length > 0 && (
        <div className="flex items-center space-x-3 mt-2">
          <Select
            placeholder={t("guardrailsPage.optionalParams.selectCategory")}
            style={{ width: 200 }}
          ...
          <span className="text-sm text-gray-500">{t("guardrailsPage.optionalParams.selectCategoryHelp")}</span>
        </div>
      )}
    </div>
  );
    ...
    return (
      <div key={fullFieldKey} className="mb-8 p-6 bg-white rounded-lg border border-gray-200 shadow-xs">
        <Form.Item
          ...
          rules={
            field.required
              ? [{ required: true, message: t("guardrailsPage.optionalParams.required", { field: fieldKey }) }]
              : undefined
          }
          className="mb-0"
    ...
    <div className="guardrail-optional-params">
      <div className="mb-8 pb-4 border-b border-gray-100">
        <Title level={3} className="mb-2 font-semibold text-gray-900">
          {t("guardrailsPage.optionalParams.title")}
        </Title>
