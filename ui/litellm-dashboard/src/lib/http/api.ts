...
/**
 * Response body of an endpoint the OpenAPI spec doesn't type yet; most GETs come
 * through as `unknown` until the backend declares a response_model. Cast untyped
 * responses to this so call sites stay uniform, and grep the name to find what
 * still needs typing; swap in the real schema type once it exists.
 */
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export type UntypedApiResponse = any;
