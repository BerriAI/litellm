 ...
 * the error handler, and AuthContext publishes the token. Keeping the seam here
 * (not importing from the component tree) lets api.ts stay in lib/http without a
 * layering inversion.
 *
