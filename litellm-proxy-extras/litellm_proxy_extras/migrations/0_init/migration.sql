...
-- CreateIndex
CREATE UNIQUE INDEX "LiteLLM_DailyTagSpend_tag_date_api_key_model_custom_llm_pro_key" ON "LiteLLM_DailyTagSpend"("tag" ASC, "date" ASC, "api_key" ASC, "model" ASC, "custom_llm_provider" ASC, "mcp_namespaced_tool_name" ASC);

-- CreateIndex
CREATE INDEX "LiteLLM_DailyTagSpend_tag_idx" ON "LiteLLM_DailyTagSpend"("tag" ASC);
...
-- CreateIndex
CREATE UNIQUE INDEX "LiteLLM_DailyTeamSpend_team_id_date_api_key_model_custom_ll_key" ON "LiteLLM_DailyTeamSpend"("team_id" ASC, "date" ASC, "api_key" ASC, "model" ASC, "custom_llm_provider" ASC, "mcp_namespaced_tool_name" ASC);

-- CreateIndex
CREATE INDEX "LiteLLM_DailyTeamSpend_team_id_idx" ON "LiteLLM_DailyTeamSpend"("team_id" ASC);
...
-- CreateIndex
CREATE UNIQUE INDEX "LiteLLM_DailyUserSpend_user_id_date_api_key_model_custom_ll_key" ON "LiteLLM_DailyUserSpend"("user_id" ASC, "date" ASC, "api_key" ASC, "model" ASC, "custom_llm_provider" ASC, "mcp_namespaced_tool_name" ASC);

-- CreateIndex
CREATE INDEX "LiteLLM_DailyUserSpend_user_id_idx" ON "LiteLLM_DailyUserSpend"("user_id" ASC);
