    ...
    if test is True:
        ...
        if (
            ...
            if is_prisma_runnable:
                from litellm_proxy_extras.litellm_proxy.db.check_migration import check_prisma_schema_diff
        ...
        from litellm_proxy_extras.litellm_proxy.proxy_server import app  # noqa
