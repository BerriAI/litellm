...
class PrismaWrapper:
    ...
    def get_rds_iam_token(self) -> Optional[str]:
        if self.iam_token_db_auth:
            from litellm_proxy_extras.litellm_proxy.auth.rds_iam_token import generate_iam_auth_token
    ...
    def setup_database(use_migrate: bool = False) -> bool:
        ...
        for attempt in range(4):
            ...
            try:
                if use_migrate:
                    try:
                        from litellm_proxy_extras.litellm_proxy_extras.utils import ProxyExtrasDBManager
