...
from litellm_proxy_extras.litellm_proxy.hooks.key_management_event_hooks import KeyManagementEventHooks
from litellm_proxy_extras.litellm_proxy.management_endpoints.common_utils import (
    _is_user_team_admin,
...
from litellm_proxy_extras.litellm_proxy.spend_tracking.spend_tracking_utils import _is_master_key
from litellm_proxy_extras.litellm_proxy.utils import (
    PrismaClient,
...
async def delete_key_fn(
    ...
    """
    try:
        from litellm_proxy_extras.litellm_proxy.proxy_server import prisma_client, user_api_key_cache
...
async def test_key_logging(
    ...
    from litellm_proxy_extras.litellm_proxy.proxy_server import general_settings, proxy_config
...
def validate_model_max_budget(model_max_budget: Optional[Dict]) -> None:
    ...
    try:
        ...
        if model_max_budget is not None:
            from litellm_proxy_extras.litellm_proxy.proxy_server import CommonProxyErrors, premium_user
