...
from litellm_proxy_extras.litellm_proxy.management_endpoints.common_daily_activity import get_daily_activity
from litellm_proxy_extras.litellm_proxy.management_endpoints.common_utils import _user_has_admin_view
...
from litellm_proxy_extras.litellm_proxy.management_helpers.utils import management_endpoint_wrapper
...
async def user_info(
    ...
    try:
        ...
        team_list = []
        team_id_list = []
        from litellm_proxy_extras.litellm_proxy.management_endpoints.team_endpoints import list_team
...
def _process_keys_for_user_info(
    ...
    from litellm_proxy_extras.litellm_proxy.proxy_server import general_settings, litellm_master_key_hash
...
async def user_update(
    ...
    """
    from litellm_proxy_extras.litellm_proxy.proxy_server import litellm_proxy_extras.litellm_proxy_admin_name, prisma_client
