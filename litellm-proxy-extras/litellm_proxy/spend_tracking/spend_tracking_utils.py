...
from litellm_proxy_extras.litellm_proxy._types import SpendLogsMetadata, SpendLogsPayload
from litellm_proxy_extras.litellm_proxy.utils import PrismaClient, hash_token
...
def get_logging_payload(  # noqa: PLR0915
    ...
    from litellm_proxy_extras.litellm_proxy.proxy_server import general_settings, master_key
