...
from litellm_proxy_extras.litellm_proxy._types import ProviderBudgetResponse, ProviderBudgetResponseObject
...
if TYPE_CHECKING:
    from litellm_proxy_extras.litellm_proxy.proxy_server import PrismaClient
else:
    PrismaClient = Any
