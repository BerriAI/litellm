...
async def initialize_pass_through_endpoints(pass_through_endpoints: list):
    ...
    from litellm_proxy_extras.litellm_proxy._types import CommonProxyErrors, LiteLLMRoutes
    from litellm_proxy_extras.litellm_proxy.proxy_server import app, premium_user
...
async def get_pass_through_endpoints(
    ...
    """
    from litellm_proxy_extras.litellm_proxy.proxy_server import get_config_general_settings
