...
from litellm_proxy_extras.litellm_proxy.db.create_views import (
    create_missing_views,
    should_create_missing_views,
)
from litellm_proxy_extras.litellm_proxy.db.db_spend_update_writer import DBSpendUpdateWriter
from litellm_proxy_extras.litellm_proxy.db.log_db_metrics import log_db_metrics
from litellm_proxy_extras.litellm_proxy.db.prisma_client import PrismaWrapper
from litellm_proxy_extras.litellm_proxy.hooks import PROXY_HOOKS, get_proxy_hook
...
class PrismaClient:
    ...
    async def _set_spend_logs_row_count_in_proxy_state(self) -> None:
        ...
        """
        from litellm_proxy_extras.litellm_proxy.proxy_server import proxy_state
