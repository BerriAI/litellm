...
from litellm_proxy_extras.litellm_proxy._types import CommonProxyErrors, CurrentItemRateLimit, UserAPIKeyAuth
...
if TYPE_CHECKING:
    ...
    from litellm_proxy_extras.litellm_proxy.utils import InternalUsageCache as _InternalUsageCache
