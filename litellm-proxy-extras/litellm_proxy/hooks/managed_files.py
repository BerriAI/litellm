...
from litellm_proxy_extras.litellm_proxy._types import CallTypes, LiteLLM_ManagedFileTable, UserAPIKeyAuth
...
if TYPE_CHECKING:
    ...
    from litellm_proxy_extras.litellm_proxy.utils import PrismaClient as _PrismaClient
