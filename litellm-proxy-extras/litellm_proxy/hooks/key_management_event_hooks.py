...
class KeyManagementEventHooks:
    ...
    async def async_key_generated_hook(
        ...
        """
        from litellm_proxy_extras.litellm_proxy.management_helpers.audit_logs import (
            create_audit_log_for_update,
        )
        from litellm_proxy_extras.litellm_proxy.proxy_server import litellm_proxy_extras.litellm_proxy_admin_name
    ...
    async def _send_key_created_email(response: dict):
        from litellm_proxy_extras.litellm_proxy.proxy_server import general_settings, proxy_logging_obj
