...
from litellm_proxy_extras.litellm_proxy._types import (  # key request types; user request types; team request types; customer request types
...
async def send_management_endpoint_alert(
    ...
    """
    from litellm_proxy_extras.litellm_proxy.proxy_server import premium_user, proxy_logging_obj
