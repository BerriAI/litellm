...
def get_optional_params_embeddings(
    ...
    **kwargs,
    ...
    elif custom_llm_provider == "vertex_ai" or custom_llm_provider == "gemini" or custom_llm_provider == "google":
        # OpenAI SDKs (and litellm's own client) send encoding_format="float"
        # by default; float lists are exactly what the vertex/gemini API returns, so
