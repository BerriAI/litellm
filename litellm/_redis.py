...
def _get_redis_cluster_kwargs(client=None):
    ...
    available_args.extend(["password", "username", "ssl", "ssl_cert_reqs", "ssl_ca_certs", "ssl_certfile", "ssl_keyfile"])
...
def get_redis_connection_pool(**env_overrides):
    ...
    # ONLY FIX: Set SSL connection class if SSL is enabled (don't remove SSL params)
