...
class CooldownCache:
    ...
    def _common_add_cooldown_logic(
        ...
        try:
            ...
            verbose_logger.error(f"CooldownCache::_common_add_cooldown_logic - Exception occurred - {e}")
            raise e
    ...
    def add_deployment_to_cooldown(
        ...
        try:
            ...
            verbose_logger.error(f"CooldownCache::add_deployment_to_cooldown - Exception occurred - {e}")
            raise e
