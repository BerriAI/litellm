...
CohereEmbeddingContentPart = MessageContentTextObject | MessageContentImageURLObject


class CohereEmbeddingContent(TypedDict):
    content: ReadOnly[list[CohereEmbeddingContentPart]]  # mutable-ok: Cohere inputs use JSON arrays


class CohereEmbeddingRequest(TypedDict, total=False):
    texts: list[str]
    images: list[str]
    inputs: ReadOnly[list[CohereEmbeddingContent]]  # mutable-ok: Cohere inputs use a JSON array
