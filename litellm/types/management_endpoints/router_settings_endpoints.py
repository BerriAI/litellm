...
ROUTER_SETTINGS_FIELDS: List[RouterSettingsField] = [
    ...
    RouterSettingsField(
        ...
        field_type="Boolean",
        field_value=None,
        field_description="Enable tag-based routing to route requests based on tags. None (default) = auto-enable when request carries tags. True = strict mode. False = disable.",
        field_default=None,
