...
def _build_key_filter_conditions(
    ...
    # Apply team_id, key_alias, project_id and access_group_id as global AND filters
    # so they narrow results across all visibility conditions (own keys, team keys, etc.)
