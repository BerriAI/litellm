...
async def generate_key_fn(
    ...
    - key: Optional[str] - User defined key value. Must start with 'sk-' and be at least 20 characters long. If not set, a 16-digit unique sk-key is created for you.
...
async def regenerate_key_fn(
    ...
    - data: Optional[RegenerateKeyRequest] - Request body containing optional parameters to update
        ...
        - new_key: Optional[str] - The new key to use, if key is not the master key. Must start with 'sk-' and be at least 20 characters long. If both set, new_master_key will be used.
        - key_alias: Optional[str] - User-friendly key alias
        - user_id: Optional[str] - User ID associated with key
        - team_id: Optional[str] - Team ID associated with key
        - models: Optional[list] - Model_name's a user is allowed to call
