...
async def list_team_v2(
    ...
    search: Optional[str] = fastapi.Query(
        default=None,
        description="Combined search: matches teams whose 'team_id' starts with the value OR whose 'team_alias' contains it (case-insensitive).",
    ),
