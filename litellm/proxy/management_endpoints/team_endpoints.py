...
async def new_team(
    ...
    - budget_limits: Optional[list] - List of concurrent budget windows for the team. Each window specifies a max_budget and budget_duration, with an optional reset_at. Example - [{"max_budget": 10.0, "budget_duration": "1d"}, {"max_budget": 50.0, "budget_duration": "7d"}].
