...
try:
    ...
    server_root_path = server_root_path or ""
    server_root_path = server_root_path.rstrip("/")

    app.mount(
        f"{server_root_path}/_next",
    ...
    app.mount(
        f"{server_root_path}/ui", StaticFiles(directory=ui_path, html=True), name="ui"
    )
