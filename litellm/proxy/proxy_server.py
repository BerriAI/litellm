...
from litellm.proxy.management_endpoints.router_management_endpoints import (
    router as router_management_router,
)
...
app.include_router(router_management_router)
