...
class ProxyBaseLLMRequestProcessing:
    ...
    def get_custom_headers(
        ...
        **kwargs,
        ...
        try:
            ...
            verbose_proxy_logger.error(
                "Error setting custom headers: %s",
                _truncate_base64_in_string(str(e)),
            )
            return {}
    ...
    async def base_process_llm_request(  # noqa: PLR0915
        ...
        # Release base64 payloads from request data now that the API call is done.
        # self.data is the long-lived reference; truncating in-place frees large
        # image strings for GC while keeping the dict usable for streaming/errors.
