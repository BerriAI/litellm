...
_ALLOWED_SESSION_TYPES = ("realtime", "transcription", "translation")
_NON_BILLABLE_REALTIME_PROTOCOL_SETTING = "allow_non_billable_realtime_protocols"
_NON_BILLABLE_REALTIME_PROTOCOL_MESSAGE = (
...
async def _prepare_client_secret_session(
    ...
    requested_session_type = req.session.type if req.session else None
    ...
    session_type = forced_session_type or _coerce_realtime_session_type(requested_session_type)
    ...
    default_model = "gpt-realtime-translate" if session_type == "translation" else _DEFAULT_REALTIME_MODEL
...
async def create_realtime_client_secret(
    ...
    try:
        ...
        is_translation_request = "/realtime/translations/client_secrets" in request.url.path
...
async def proxy_realtime_calls(
    ...
    is_translation_request = "/realtime/translations/calls" in request.url.path
