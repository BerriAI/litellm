...
def get_request_base_url(request: Request) -> str:
    ...
    Note: ProxyBaseUrlMiddleware in proxy_server.py is responsible for correctly
    reconstructing the host/scheme in the ASGI scope based on X-Forwarded-* headers
    or PROXY_BASE_URL. This function returns the corrected base URL.
