...
async def create_file(
    ...
    try:
        ...
        # Forward the OpenAI-Project request header so project-scoped API keys work
        openai_project_header: Final = request.headers.get("openai-project")
        if openai_project_header and not data.get("project"):
            data["project"] = openai_project_header
