...
def initialize_guardrail(litellm_params: "LitellmParams", guardrail: "Guardrail"):
    ...
    _hlido_callback = HlidoGuardrail(
        ...
        trust_request_slugs=_config_value("trust_request_slugs"),
        max_request_slugs=_config_value("max_request_slugs"),
        request_timeout=_config_value("request_timeout"),
        max_cache_entries=_config_value("max_cache_entries"),
