...
def initialize_aporia(litellm_params, guardrail):
    ...
    litellm.logging_callback_manager.add_callback(_aporia_callback)
...
def initialize_bedrock(litellm_params, guardrail):
    ...
    litellm.logging_callback_manager.add_callback(_bedrock_callback)
...
def initialize_lakera(litellm_params, guardrail):
    ...
    litellm.logging_callback_manager.add_callback(_lakera_callback)
...
def initialize_aim(litellm_params, guardrail):
    ...
    litellm.logging_callback_manager.add_callback(_aim_callback)
...
def initialize_presidio(litellm_params, guardrail):
    ...
    litellm.logging_callback_manager.add_callback(_presidio_callback)
    ...
    if litellm_params["output_parse_pii"]:
        ...
        litellm.logging_callback_manager.add_callback(_success_callback)
...
def initialize_hide_secrets(litellm_params, guardrail):
    ...
    litellm.logging_callback_manager.add_callback(_secret_detection_object)
...
def initialize_guardrails_ai(litellm_params, guardrail):
    ...
    litellm.logging_callback_manager.add_callback(_guardrails_ai_callback)
