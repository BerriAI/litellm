...
ROUTE_ENDPOINT_MAPPING = {
    ...
    "aget_skill_content": "/skills/{skill_id}/content",
    "acreate_skill_version": "/skills/{skill_id}/versions",
    "alist_skill_versions": "/skills/{skill_id}/versions",
    "aget_skill_version": "/skills/{skill_id}/versions/{version}",
    "adelete_skill_version": "/skills/{skill_id}/versions/{version}",
    "aget_skill_version_content": "/skills/{skill_id}/versions/{version}/content",
    "aingest": "/rag/ingest",
