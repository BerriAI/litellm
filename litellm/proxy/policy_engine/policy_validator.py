...
class PolicyValidator:
    ...
    def get_available_guardrails(self) -> set[str]:
        ...
        try:
            ...
            verbose_proxy_logger.warning(f"Could not get guardrails from registry: {e}")
            return set()
    ...
    async def check_team_alias_exists(self, team_alias: str) -> bool:
        ...
        try:
            ...
            verbose_proxy_logger.warning(f"Could not check team alias '{team_alias}': {e}")
    ...
    async def check_key_alias_exists(self, key_alias: str) -> bool:
        ...
        try:
            ...
            verbose_proxy_logger.warning(f"Could not check key alias '{key_alias}': {e}")
            return True  # Assume valid on error
    ...
    def check_model_exists(self, model: str) -> bool:
        ...
        try:
            ...
            verbose_proxy_logger.warning(f"Could not check model '{model}': {e}")
            return True  # Assume valid on error
