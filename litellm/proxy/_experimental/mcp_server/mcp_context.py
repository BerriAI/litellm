...
_mcp_active_toolset_id: ContextVar[str | None] = ContextVar("_mcp_active_toolset_id", default=None)

# Per-request merged InitializeResult.instructions; set in MCP HTTP/SSE handlers.
_mcp_gateway_initialize_instructions: ContextVar[str | None] = ContextVar(
...
_mcp_gateway_server_name: ContextVar[str | None] = ContextVar("_mcp_gateway_server_name", default=None)
