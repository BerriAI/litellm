...
client = openai.OpenAI(
	api_key="${x||"YOUR_LITELLM_API_KEY"}",
	base_url="${y}"
)`;switch(h){case i.CHAT:{let e=Object.keys(C).length>0,o="";if(e){let e=JSON.stringify({metadata:C},null,2).split("\n").map(e=>" ".repeat(4)+e).join("\n").trim();o=`,
