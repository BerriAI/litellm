...
client = openai.OpenAI(
	api_key="${_||"YOUR_LITELLM_API_KEY"}",
	base_url="${x}"
)`;switch(h){case r.CHAT:{let e=Object.keys(w).length>0,i="";if(e){let e=JSON.stringify({metadata:w},null,2).split("\n").map(e=>" ".repeat(4)+e).join("\n").trim();i=`,
    extra_body=${e}`}let o=C.length>0?C:[{role:"user",content:A}];t=`
import base64
...
${t}`}],339019)},157058,e=>{"use strict";var t=e.i(843476),i=e.i(934879),o=e.i(976883),r=e.i(135214),n=e.i(708347);e.s(["default",0,function(){let{accessToken:e,userRole:a,premiumUser:l}=(0,r.default)();return(0,n.isAdminRole)(a)?(0,t.jsx)(i.default,{accessToken:e,publicPage:!1,premiumUser:l,userRole:a}):(0,t.jsx)(o.default,{accessToken:e,isEmbedded:!0})}])}]);