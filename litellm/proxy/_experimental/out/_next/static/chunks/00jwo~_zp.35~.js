...
client = openai.OpenAI(
    ...
    extra_body=${e}`}let a=k.length>0?k:[{role:"user",content:S}];t=`
import base64
...
if image_data:
	...
	print(response)
`;break;case o.IMAGE_EDITS:t="azure"===x?`
import base64
import os
import time
import json
