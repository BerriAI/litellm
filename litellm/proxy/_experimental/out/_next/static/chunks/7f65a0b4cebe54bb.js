...
client = openai.OpenAI(
	api_key="${C||"YOUR_LITELLM_API_KEY"}",
	base_url="${_}"
)`;switch(f){case o.CHAT:{let e=Object.keys(A).length>0,i="";if(e){let e=JSON.stringify({metadata:A},null,2).split("\n").map(e=>" ".repeat(4)+e).join("\n").trim();i=`,
...
${t}`}],339019)},157058,e=>{"use strict";var t=e.i(843476),i=e.i(934879),r=e.i(976883),o=e.i(135214),a=e.i(708347);function n(){let{accessToken:e,userRole:n,premiumUser:l}=(0,o.default)();return(0,a.isAdminRole)(n)?(0,t.jsx)(i.default,{accessToken:e,publicPage:!1,premiumUser:l,userRole:n}):(0,t.jsx)(r.default,{accessToken:e,isEmbedded:!0})}e.s(["default",()=>n])}]);