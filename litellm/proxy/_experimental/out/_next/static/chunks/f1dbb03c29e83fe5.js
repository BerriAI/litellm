...
client = openai.OpenAI(
	api_key="${v||"YOUR_LITELLM_API_KEY"}",
	base_url="${I}"
)`;switch(_){case r.CHAT:{let e=Object.keys(T).length>0,a="";if(e){let e=JSON.stringify({metadata:T},null,2).split("\n").map(e=>" ".repeat(4)+e).join("\n").trim();a=`,
