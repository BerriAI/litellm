...
client = openai.OpenAI(
    ...
    extra_body=${e}`}let i=y.length>0?y:[{role:"user",content:O}];t=`
import base64
...
if image_data:
	...
	print(response)
`;break;case o.IMAGE_EDITS:t="azure"===h?`
import base64
import os
import time
import json
