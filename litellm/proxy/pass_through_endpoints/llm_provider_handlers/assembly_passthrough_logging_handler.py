...
class AssemblyAIPassthroughLoggingHandler:
    ...
    def _get_assembly_transcript(
        ...
        try:
            ...
            verbose_proxy_logger.exception(f"[Non blocking logging error] Error getting AssemblyAI transcript: {e}")
            return None
    ...
    def get_cost_per_second_for_assembly_model(speech_model: str) -> float | None:
        ...
        try:
            ...
            verbose_proxy_logger.exception(f"[Non blocking logging error] Error getting AssemblyAI model info: {e}")
            return None
