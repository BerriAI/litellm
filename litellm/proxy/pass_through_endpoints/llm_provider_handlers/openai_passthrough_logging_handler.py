...
class OpenAIPassthroughLoggingHandler(BasePassthroughLoggingHandler):
    ...
    def _calculate_image_generation_cost(
        ...
        try:
            ...
            verbose_proxy_logger.warning(f"Error calculating image generation cost: {e}")
            return 0.0
    ...
    def _calculate_image_editing_cost(
        ...
        try:
            ...
            verbose_proxy_logger.warning(f"Error calculating image editing cost: {e}")
            return 0.0
    ...
    def openai_passthrough_handler(
        ...
        **kwargs,
        ...
        try:
            ...
            verbose_proxy_logger.error(f"Error in OpenAI passthrough cost tracking: {e}")
    ...
    def _build_complete_streaming_response(
        ...
        try:
            ...
            verbose_proxy_logger.error(f"Error building complete streaming response: {e}")
            return None
    ...
    def _handle_logging_openai_collected_chunks(
        ...
        try:
            ...
            # Extract user information for tracking
            passthrough_logging_payload: PassthroughStandardLoggingPayload | None = (
            ...
            verbose_proxy_logger.error(f"Error in OpenAI streaming passthrough cost tracking: {e}")
            return {
                "result": None,
                "kwargs": {},
            }
