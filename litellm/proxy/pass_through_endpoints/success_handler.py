    ...
    def normalize_llm_passthrough_logging_payload(
        ...
        **kwargs,
        ...
        if self.is_gemini_route(url_route, custom_llm_provider):
            ...
            parallel_ai_passthrough_logging_handler_result: Final = (
                ParallelAIPassthroughLoggingHandler.parallel_ai_extract_handler(
                    response_body=response_body if isinstance(response_body, dict) else {},
                    logging_obj=logging_obj,
                    request_body=request_body,
                    **kwargs,
            ...
            standard_logging_response_object = parallel_ai_passthrough_logging_handler_result["result"]
            kwargs = parallel_ai_passthrough_logging_handler_result["kwargs"]
