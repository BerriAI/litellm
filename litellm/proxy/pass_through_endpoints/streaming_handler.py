...
class PassThroughStreamingHandler:
    ...
    async def chunk_processor(
        ...
        try:
            ...
            verbose_proxy_logger.error(f"Error in chunk_processor: {e}")
            raise
        finally:
            ...
            if not logging_scheduled and raw_bytes and response.status_code < 400:
                ...
                try:
                    ...
                    verbose_proxy_logger.error(f"Error scheduling chunk_processor logging: {e}")
    ...
    async def _route_streaming_logging_to_handler(
        ...
        try:
            ...
            verbose_proxy_logger.error(f"Error in _route_streaming_logging_to_handler: {e}")
