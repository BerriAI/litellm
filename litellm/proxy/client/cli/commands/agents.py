...
def build_agent_env(
    ...
    Anthropic key cannot win over the bearer token we set. ENABLE_TOOL_SEARCH is
    forced on because Claude Code turns tool search off when ANTHROPIC_BASE_URL
