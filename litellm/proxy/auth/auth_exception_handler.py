...
from litellm.proxy.auth.auth_utils import _get_request_ip_address, resolve_request_route_for_metrics
    ...
    async def _handle_authentication_error(
        ...
        if (
            ...
            return UserAPIKeyAuth(
                ...
                request_route=resolve_request_route_for_metrics(request, route),
            )
        else:
            ...
            user_api_key_dict.request_route = resolve_request_route_for_metrics(request, route)
