...
async def get_end_user_object(
    ...
    if cached_user_obj is not None:
        ...
        had_no_budget = return_obj.litellm_budget_table is None
        ...
        # Update cache so subsequent requests don't re-trigger budget persistence
        if had_no_budget and return_obj.litellm_budget_table is not None:
            await user_api_key_cache.async_set_cache(
                key=_key,
                value=return_obj.model_dump(),
            )
