...
async def get_vantage_settings(
    ...
    try:
        ...
        verbose_proxy_logger.error(f"Error retrieving Vantage settings: {e!s}")
        raise HTTPException(
            status_code=500,
            detail={"error": f"Failed to retrieve Vantage settings: {e!s}"},
        )
...
async def update_vantage_settings(
    ...
    try:
        ...
        verbose_proxy_logger.error(f"Error updating Vantage settings: {e!s}")
        raise HTTPException(
            status_code=500,
            detail={"error": f"Failed to update Vantage settings: {e!s}"},
        )
...
async def is_vantage_setup_in_db() -> bool:
    ...
    try:
        ...
        verbose_proxy_logger.error(f"Error checking Vantage status: {e!s}")
        return False
...
async def is_vantage_setup() -> bool:
    ...
    try:
        ...
        verbose_proxy_logger.error(f"Error checking Vantage setup: {e!s}")
        return False
...
async def init_vantage_settings(
    ...
    try:
        ...
        verbose_proxy_logger.error(f"Error initializing Vantage settings: {e!s}")
        raise HTTPException(
            status_code=500,
            detail={"error": f"Failed to initialize Vantage settings: {e!s}"},
        )
...
async def vantage_dry_run_export(
    ...
    try:
        ...
        verbose_proxy_logger.error(f"Error performing Vantage dry run export: {e!s}")
        raise HTTPException(
            status_code=500,
            detail={"error": f"Failed to perform Vantage dry run export: {e!s}"},
        )
...
async def vantage_export(
    ...
    try:
        ...
        verbose_proxy_logger.error(f"Error performing Vantage export: {e!s}")
        raise HTTPException(
            status_code=500,
            detail={"error": f"Failed to perform Vantage export: {e!s}"},
        )
...
async def delete_vantage_settings(
    ...
    try:
        ...
        verbose_proxy_logger.error(f"Error deleting Vantage settings: {e!s}")
        raise HTTPException(
            status_code=500,
            detail={"error": f"Failed to delete Vantage settings: {e!s}"},
        )
