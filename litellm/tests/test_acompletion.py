...
def test_acompletion_params():
    ...
    completion_params = {
        ...
        for field_name, field_type in CompletionRequest.__annotations__.items()
    }
    ...
    if keys_acompletion != keys_completion:
        pytest.fail(
            "The parameters of the acompletion function and the CompletionRequest class are not the same."
        )
