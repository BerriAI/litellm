...
class DataRobotConfig(OpenAIGPTConfig):
    def map_openai_params(
        ...
        extra_body = {}
        llm_id = non_default_params.pop("llm_id", None)
        credential_ids = non_default_params.pop("credential_ids", None)
        if llmId is not None:
            extra_body["llmId"] = llm_id
        if llmId is not None:
            extra_body["credentialIds"] = credential_ids
    ...
    def get_model_response_iterator(
        ...
        return DataRobotChatCompletionStreamingHandler(
