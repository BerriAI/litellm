...
from ..common_utils import ModelResponseIterator as BytezModelResponseIterator
from ..common_utils import validate_environment as bytez_validate_environment
...
class BytezError(BaseLLMException):
    def __init__(
        ...
        self.request = httpx.Request(
            method="POST", url="https://api.bytez.com/models/v2"
        )
...
class BytezChatConfig(BaseConfig):
    ...
    def validate_environment(
        ...
        return bytez_validate_environment(
            headers=headers,
            model=model,
            messages=messages,
    ...
    def get_model_response_iterator(
        ...
        return BytezModelResponseIterator(
