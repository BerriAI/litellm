...
class BasetenConfig(OpenAIGPTConfig):
    ...
    The class `BasetenConfig` provides configuration for the Fireworks's Chat Completions API interface. Below are the parameters:
    """
    ...
    def _get_openai_compatible_provider_info(
        ...
        return "", "", ""
        # if BasetenEmbeddingConfig().is_fireworks_embedding_model(model=model):
