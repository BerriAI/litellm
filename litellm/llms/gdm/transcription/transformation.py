...
class GDMException(BaseLLMException):
    def __init__(
        self,
        status_code: int,
        message: str,
...
class GDMTranscriptionConfig(BaseAudioTranscriptionConfig):
    ...
    def transform_audio_transcription_response(
        ...
        """
        Transform GDM audio transcription response to OpenAI-compatible TranscriptionResponse.
        """
        try:
