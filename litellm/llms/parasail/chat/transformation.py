...
class ParasailChatConfig(OpenAILikeChatConfig):
    ...
    def _get_openai_compatible_provider_info(
        ...
        # parasail is openai compatible, we just need to set this to custom_openai and have the api_base be https://api.parasail.io/v1
        api_base = (
            api_base
    ...
    def _should_fake_stream(self, optional_params: dict) -> bool:
        """
        Parasail doesn't support 'response_format' while streaming
        """
    ...
    def _create_json_tool_call_for_response_format(
        ...
        Returns:
            ChatCompletionToolParam: The tool call to send to Parasail API to get responses in JSON format
        """
    ...
    def map_openai_params(
        ...
        replace_max_completion_tokens_with_max_tokens: bool = False,  # parasail supports max_completion_tokens
    ) -> dict:
        ...
        if _response_format is not None and isinstance(_response_format, dict):
            ...
            if json_schema is not None:
                ...
                )  # only remove if it's a json_schema - handled via using parasail's tool calling params.
