...
class GenAIHubEmbeddingConfig(BaseEmbeddingConfig):
    ...
    def _add_api_version_to_url(self, url: str, api_version: str) -> str:
        ...
        api_version = DEFAULT_API_VERSION if not api_version or api_version is None or api_version == "None" else api_version
    ...
    def transform_embedding_request(self,
                                    model: str,
    ...
    def transform_embedding_response(self,
                                     model: str,
