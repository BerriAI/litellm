...
class VertexAIRerankConfig(BaseRerankConfig, VertexBase):
    ...
    def validate_environment(
        ...
        vertex_params = optional_params.copy() if optional_params else {}
        vertex_credentials = self.safe_get_vertex_ai_credentials(vertex_params)
        vertex_project = self.safe_get_vertex_ai_project(vertex_params)
