...
class VertexGeminiConfig(VertexAIBaseConfig, BaseConfig):
    ...
    def _map_reasoning_effort_to_thinking_level(
        ...
        is_gemini3flash = model and ("gemini-3-flash" in model.lower() or "gemini-3.1-flash" in model.lower())
    ...
    def _calculate_usage(  # noqa: PLR0915
        ...
        if usage_metadata.get("responseTokensDetails"):
        ...
        if usage_metadata.get("candidatesTokensDetails"):
        ...
        if usage_metadata.get("promptTokensDetails"):
        ...
        if usage_metadata.get("cacheTokensDetails"):
...
class ModelResponseIterator:
    def __init__(self, streaming_response, sync_stream: bool, logging_obj: LoggingClass):
        from litellm.litellm_core_utils.prompt_templates.common_utils import (
    ...
    def chunk_parser(self, chunk: dict) -> Optional["ModelResponseStream"]:
        try:
            ...
            if "usageMetadata" in processed_chunk:
                ...
                if traffic_type:
                    model_response._hidden_params.setdefault("provider_specific_fields", {})["traffic_type"] = (
                        traffic_type
                    )
