...
class YouComSearchConfig(BaseSearchConfig):
    ...
    # Used automatically when YDC_API_KEY is not set.
    ...
    def validate_environment(
        ...
        **kwargs,
        ...
        If YDC_API_KEY (or an explicit api_key) is present, use the keyed
    ...
    def get_complete_url(
        ...
        **kwargs,
        ...
        - YDC_API_KEY set                -> keyed endpoint (ydc-index.io/v1/search)
        ...
        if api_base is None:
            api_key = kwargs.get("api_key") or get_secret_str("YDC_API_KEY") or get_secret_str("YOUCOM_API_KEY")
            if api_key:
