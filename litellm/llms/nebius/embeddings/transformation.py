...
class NebiusError(BaseLLMException):
    def __init__(
        ...
        self.request = httpx.Request(
            method="POST", url=" https://api.studio.nebius.ai/v1/embeddings"
        )
...
class NebiusEmbeddingConfig(BaseEmbeddingConfig):
    """
    Reference: https://docs.nebius.com/studio/inference/api#embeddings
    """
    ...
    def get_complete_url(
        ...
        if api_base:
            ...
            return api_base
        return " https://api.studio.nebius.ai/v1/embeddings"
    ...
    def map_openai_params(
        ...
        """
        Map OpenAI params to Nebius params
    ...
    def validate_environment(
        ...
        if api_key is None:
            api_key = (
                get_secret_str("NEBIUS_API_KEY")
                or get_secret_str("NEBIUS_AI_API_KEY")
                or get_secret_str("NEBIUS_AI_TOKEN")
            )
        return {
