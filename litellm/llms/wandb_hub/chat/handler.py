"""
Wandb Hub chat completion handler

For handling Wandb Hub chat completions through their OpenAI-compatible API.
"""
...
from .transformation import WandbHubChatConfig
...
class WandbHubChatHandler(OpenAILikeBase):
    ...
    async def acompletion_function(
        ...
        return WandbHubChatConfig().transform_response(
            model=model,
    ...
    def completion(
        ...
        *,
        ...
        # Transform request using WandbHubChatConfig
