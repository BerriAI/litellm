...
def get_tokenhub_base_url(api_base: Optional[str] = None) -> str:
    """
    Get the base URL for TokenHub API calls.
...
def get_tokenhub_headers(api_key: str, extra_headers: Optional[dict] = None) -> dict:
    """
    Get headers for TokenHub API calls.
