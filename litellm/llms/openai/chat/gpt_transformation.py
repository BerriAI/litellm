...
class OpenAIGPTConfig(BaseLLMModelInfo, BaseConfig):
    ...
    def remove_cache_control_flag_from_messages_and_tools(
        ...
        copied_messages: Final = [
            cast(AllMessageValues, filter_value_from_dict(copy.deepcopy(message), "cache_control"))
            for message in messages
        ]
        copied_tools: Final = (
            [
                cast(ChatCompletionToolParam, filter_value_from_dict(copy.deepcopy(tool), "cache_control"))
                for tool in tools
            ]
