...
class OCIChatConfig(BaseConfig):
    ...
    def transform_request(
        ...
        if vendor == OCIVendors.COHERE:
            ...
            non_system_messages: Final = [m for m in messages if m.get("role") != "system"]
            tool_results: Final = extract_cohere_tool_results(non_system_messages)
            ...
            message: Final = "" if tool_results else cohere_message_text(non_system_messages[-1])
