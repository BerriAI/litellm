# Handler file for IO Intelligence embedding endpoints.
...
from ..common_utils import IOIntelligenceBase, IOIntelligenceError


class IOIntelligenceEmbeddingHandler(IOIntelligenceBase):
        ...
        try:
            if client is None or not isinstance(client, AsyncHTTPHandler):
                async_client = get_async_httpx_client(
                    llm_provider=litellm.LlmProviders.IO_INTELLIGENCE,
            ...
            try:
                ...
                raise IOIntelligenceError(status_code=500, message=str(e))
