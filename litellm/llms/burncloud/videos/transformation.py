...
class BurnCloudVideoConfig(BaseVideoConfig):
    def __init__(self):
        super().__init__()
    ...
    def transform_video_content_request(
        ...
        """
        Transform the video content request for BurnCloud API.

        BurnCloud API expects the following request:
    ...
    def transform_video_status_retrieve_response(
        ...
        """
        Transform the BurnCloud video retrieve response.
        """
        response_data = raw_response.json()
