...
class ModelRepository(BaseRepository[Model]):
    ...
    def _to_model(self, record: Any) -> Optional[Model]:
    ...
    async def find_by_name(self, model_name: str) -> List[Model]:
        """Find models by name."""
    ...
    async def find_unblocked(self) -> List[Model]:
    ...
    async def block_model(self, model_id: str, updated_by: str) -> Optional[Model]:
        """Block a model."""
        return await self.update_model(model_id, updated_by, blocked=True)

    async def unblock_model(self, model_id: str, updated_by: str) -> Optional[Model]:
        """Unblock a model."""
