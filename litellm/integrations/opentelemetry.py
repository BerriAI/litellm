...
class OpenTelemetry(CustomLogger):
    def __init__(
        ...
        **kwargs,
        ...
        self.config = config
        # Store as a string to avoid Optional[str] leakage in downstream calls
        self.callback_name = callback_name or ""
    ...
    def _emit_semantic_logs(self, kwargs, response_obj, span: Span):
        ...
        # LogRecord import path changed across OpenTelemetry SDK versions.
        # Keep runtime-compatible behavior without failing mypy.
        SdkLogRecord: Any = None
        try:
            from opentelemetry.sdk._logs._internal import (  # type: ignore[import-not-found]
                LogRecord as _SdkLogRecordInternal,
            )
