        ...
        **kwargs,
        ...
        try:
            ...
            self.litellm_managed_file_created_total = self._counter_factory(
                ...
                labelnames=self.get_labels_for_metric("litellm_managed_file_created_total"),
            )
            ...
            self.litellm_check_batch_cost_jobs_processed_total = self._counter_factory(
                ...
                labelnames=self.get_labels_for_metric("litellm_check_batch_cost_jobs_processed_total"),
            )
