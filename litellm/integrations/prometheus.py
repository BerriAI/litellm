...
class PrometheusLogger(CustomLogger):
    ...
    def record_check_batch_cost_run(
        ...
        """
        Record metrics for a single CheckBatchCost poll cycle.
        ...
        try:
            ...
            verbose_logger.warning(f"Error recording check batch cost run metric: {e}")

    def record_check_batch_cost_error(self, error_type: str):
        """Record an error during CheckBatchCost processing."""
        try:
