...
class AdminDestinationLogger(CustomLogger):
    ...
    def __init__(self, **kwargs: Any) -> None:  # noqa: ANN401  # forwarded verbatim to CustomLogger
...
def register_admin_destination_logger() -> None:
    ...
    for bucket in (litellm._async_success_callback, litellm._async_failure_callback):  # pyright: ignore[reportPrivateUsage]  # the proxy's own callback lists
