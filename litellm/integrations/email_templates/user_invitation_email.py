"""
Modern Email Templates for ArcheOps Email Service with professional styling
"""
...
<head>
    ...
    <title>Welcome to ArcheOps</title>
    <style>
        body, html {{
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <div class="logo">
            <img src="{email_logo_url}" alt="ArcheOps Logo" style="height: 32px; width: auto;">
        </div>
        <div class="content">
            <h1>Welcome to ArcheOps</h1>
            ...
            <div class="intro-text">
                <p>ArcheOps allows you to call 100+ LLM providers in the OpenAI API format. Get started by accepting your invitation.</p>
            </div>
            ...
            <p>View all supported LLM endpoints on ArcheOps (/chat/completions, /embeddings, /responses etc.)</p>
