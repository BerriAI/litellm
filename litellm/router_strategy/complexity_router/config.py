...
class ComplexityRouterConfig(BaseModel):
    ...
    prompt_cache_key_as_session_id: bool = Field(
        ...
        description=(
            ...
            "fallback accepts non-empty values up to OpenAI's 64-character limit and hashes them before they "
            "enter router cache keys. This enables session_affinity and classification_mode='user_turn' for "
