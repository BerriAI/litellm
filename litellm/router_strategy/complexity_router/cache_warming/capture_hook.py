...
def _warn_privacy_gate_blocked(auto_router_model_name: str) -> None:
    verbose_router_logger.warning(
        "cache_warming is enabled for auto-router %s but store_prompts_in_spend_logs is not enabled; "
        "cache warming stores full request payloads in Redis and stays inactive until that consent flag is set",
...
class ComplexityCacheWarmingCaptureHook(CustomLogger):
    def __init__(self, privacy_gate: "Callable[[], bool]" = _privacy_gate_allows) -> None:
