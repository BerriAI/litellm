...
class CyberArkSecretManager(BaseSecretManager):
    ...
    def _ensure_variable_exists(self, secret_name: str) -> None:
        ...
        # Force double-quoted scalar style so any YAML metacharacter in secret_name
        # (newlines, other Unicode line breaks, colons, '#' comments) is escaped
        # instead of being interpreted as new policy syntax.
