...
def select_cost_metric_for_model(
...
) -> Literal["cost_per_character", "cost_per_token", "cost_per_video_per_second"]:
    """
    ...
    Select 'cost_per_video_per_second' if model_info has 'input_cost_per_video_per_second'
    """
    if model_info.get("input_cost_per_character"):
        return "cost_per_character"
    elif model_info.get("input_cost_per_token"):
        return "cost_per_token"
    elif model_info.get("input_cost_per_video_per_second"):
        return "cost_per_video_per_second"
    else:
        raise ValueError(
            f"Model {model_info['key']} does not have 'input_cost_per_character', 'input_cost_per_token', or 'input_cost_per_video_per_second'"
        )
