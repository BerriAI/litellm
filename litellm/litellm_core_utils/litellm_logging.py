    ...
    async def _async_success_handler_body(
        ...
        **kwargs: Any,  # kwargs-ok: forwarded from async_success_handler
        ...
        if complete_streaming_response is not None:
            ...
            except Exception:  # noqa: BLE001  # cost calculation must never block slot-release callbacks
                verbose_logger.exception(
            ...
            except Exception:  # noqa: BLE001  # payload build must never block slot-release callbacks
                verbose_logger.exception(
