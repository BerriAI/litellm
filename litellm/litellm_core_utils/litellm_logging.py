...
class Logging(LiteLLMLoggingBaseClass):
    ...
    async def async_success_handler(  # noqa: PLR0915
        ...
        self.should_run_logging(event_type="async_success")  # prevent double logging
    ...
    def failure_handler(  # noqa: PLR0915
        ...
        self.should_run_logging(event_type="sync_failure")  # prevent double logging
        try:
    ...
    async def async_failure_handler(
        ...
        self.should_run_logging(event_type="async_failure")  # prevent double logging
        start_time, end_time = self._failure_handler_helper_fn(
            exception=exception,
            traceback_exception=traceback_exception,
            start_time=start_time,
