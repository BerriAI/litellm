...
class Logging(LiteLLMLoggingBaseClass):
    ...
    def _get_assembled_streaming_response(
        ...
        if isinstance(result, ModelResponse) or isinstance(result, TextCompletionResponse):
            ...
            # `result.response` may be a plain dict on the streaming /v1/responses
            # spend-log path (#29913) because ResponseCompletedEvent allows extra
            # fields; a bare `.usage` access raises AttributeError there and no
            # spend row is written at all.
