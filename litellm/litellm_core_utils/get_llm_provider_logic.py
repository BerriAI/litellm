...
def get_llm_provider(  # noqa: PLR0915
    ...
    try:
        ...
        # model ID (e.g. "anthropic/claude-sonnet-4.5", not
        # "openrouter/anthropic/claude-sonnet-4.5").  Without this strip the
        # /v1/messages endpoint returns 400 "not a valid model ID".
        #
