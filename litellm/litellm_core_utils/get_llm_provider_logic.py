            ...
            for endpoint in litellm.openai_compatible_endpoints:
                if _endpoint_matches_api_base(endpoint, api_base):
                    if endpoint == "api.perplexity.ai":
                        ...
                        custom_llm_provider = "requesty"  # rebind-ok: provider resolution rebinds the parameter like every branch above
...
def _get_openai_compatible_provider_info(
    ...
    # publicai is now handled by JSON config (see litellm/llms/openai_like/providers.json)
        ...
        (
            api_base,  # rebind-ok: provider resolution rebinds the parameter like every branch above
            dynamic_api_key,  # rebind-ok: provider resolution rebinds the parameter like every branch above
