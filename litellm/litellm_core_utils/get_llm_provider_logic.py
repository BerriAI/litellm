...
def get_llm_provider(
    ...
    try:
        ...
        # bytez models
            ...
            custom_llm_provider = "byteplus"  # rebind-ok: model prefix match
...
def _get_openai_compatible_provider_info(
    ...
    if custom_llm_provider == "perplexity":
        ...
        api_base = (  # rebind-ok: fallback base url
            api_base
            or get_secret("BYTEPLUS_API_BASE")
            or get_secret("ARK_API_BASE")
            or "https://ark.ap-southeast.bytepluses.com/api/v3"
        )
        dynamic_api_key = api_key or get_secret_str("BYTEPLUS_API_KEY") or get_secret_str("ARK_API_KEY")  # rebind-ok: fallback api key
