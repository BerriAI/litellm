...
from litellm.types.caching import CachedEmbedding, CachingSupportedCallTypes, LiteLLMCacheType
...
@disjoint_base
class Cache:
    """`litellm.caching.caching.Cache`: the response-cache facade behind `litellm.cache`."""

    _SEMANTIC_CACHE_SCOPE_EXCLUDED_PARAMS: frozenset[str]
    _SEMANTIC_CACHE_TENANT_SCOPE_FIELDS: tuple[str, ...]
    _SEMANTIC_CACHE_END_USER_SCOPE_FIELD: str
    type: LiteLLMCacheType | str | None
    mode: object
    ttl: float | None
    namespace: str | None
    redis_flush_size: int | None
    supported_call_types: list[CachingSupportedCallTypes] | None
    semantic_cache_scope: str
    def __new__(cls, *args: object, **kwargs: object) -> Cache: ...
    def __init__(self, *args: object, **kwargs: object) -> None: ...
    @property
    def cache(self) -> BaseCache: ...
    @cache.setter
    def cache(self, backend: BaseCache) -> None: ...
    def _is_semantic_cache(self) -> bool: ...
    def _semantic_cache_scope_fields(self) -> tuple[str, ...]: ...
    def _get_semantic_cache_tenant_scope(self, kwargs: Mapping[str, object]) -> str: ...
    def get_cache_key(self, **kwargs: object) -> str: ...
    def _get_param_value(self, param: str, kwargs: Mapping[str, object]) -> object: ...
    def _get_model_param_value(self, kwargs: Mapping[str, object]) -> object: ...
    def _get_caching_group(self, metadata: Mapping[str, object], model_group: object) -> object: ...
    def _get_file_param_value(self, kwargs: Mapping[str, object]) -> object: ...
    def _get_preset_cache_key_from_kwargs(self, **kwargs: object) -> object: ...
    def _set_preset_cache_key_in_kwargs(self, preset_cache_key: object, **kwargs: object) -> None: ...
    @staticmethod
    def _get_hashed_cache_key(cache_key: str) -> str: ...
    def _add_namespace_to_cache_key(self, hash_hex: str, **kwargs: object) -> str: ...
    def generate_streaming_content(self, content: str) -> Iterator[dict[str, object]]: ...
    def _get_cache_logic(self, cached_result: object, max_age: object) -> object: ...
    @staticmethod
    ...
    def _update_metadata_from_cache_lookup_kwargs(
        ...
        cache_lookup_kwargs: Mapping[str, object],
    ) -> None: ...
    @staticmethod
    def _stamp_semantic_similarity(kwargs: Mapping[str, object], similarity: float | None) -> None: ...
    def get_cache(self, dynamic_cache_object: BaseCache | None = None, **kwargs: object) -> object: ...
    def async_get_cache(
        self,
        dynamic_cache_object: BaseCache | None = None,
        **kwargs: object,
    ) -> Coroutine[object, object, object]: ...
    def _add_cache_logic(
        self,
        result: object,
        **kwargs: object,
    ) -> tuple[object, dict[str, object], dict[str, object]]: ...
    def add_cache(self, result: object, **kwargs: object) -> None: ...
    def _log_add_cache_failure(self, exc: BaseException) -> None: ...
    def async_add_cache(
        self,
        result: object,
        dynamic_cache_object: BaseCache | None = None,
    ...
    def _get_per_item_prompt_tokens(self, result: EmbeddingResponse, idx_in_result_data: int) -> int | None: ...
    ...
    def async_add_cache_pipeline(
        self,
        result: object,
        dynamic_cache_object: BaseCache | None = None,
        **kwargs: object,
    ) -> Coroutine[object, object, None]: ...
    def should_use_cache(self, **kwargs: object) -> bool: ...
    def batch_cache_write(self, result: object, **kwargs: object) -> Awaitable[object]: ...
    def ping(self) -> Awaitable[object]: ...
    def delete_cache_keys(self, keys: Sequence[str]) -> Awaitable[object]: ...
