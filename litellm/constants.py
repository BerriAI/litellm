...
DEFAULT_REASONING_EFFORT_LOW_THINKING_BUDGET = int(
    os.getenv("DEFAULT_REASONING_EFFORT_LOW_THINKING_BUDGET", 2000)
)
DEFAULT_REASONING_EFFORT_MEDIUM_THINKING_BUDGET = int(
    os.getenv("DEFAULT_REASONING_EFFORT_MEDIUM_THINKING_BUDGET", 5000)
)
DEFAULT_REASONING_EFFORT_HIGH_THINKING_BUDGET = int(
    os.getenv("DEFAULT_REASONING_EFFORT_HIGH_THINKING_BUDGET", 10000)
)
DEFAULT_REASONING_EFFORT_XHIGH_THINKING_BUDGET = int(
    os.getenv("DEFAULT_REASONING_EFFORT_XHIGH_THINKING_BUDGET", 20000)
)
DEFAULT_REASONING_EFFORT_MAX_THINKING_BUDGET = int(
    os.getenv("DEFAULT_REASONING_EFFORT_MAX_THINKING_BUDGET", 40000)
)
