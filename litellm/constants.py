...
# ``litellm_settings: otel_tenant_internal_spans`` value (and its env equivalent) that
# keeps the proxy's own SERVICE and DB_CALL spans out of tenant OTel destinations.
