...
DEFAULT_S3_MAX_ADAPTIVE_CONCURRENCY: Final = int(os.getenv("DEFAULT_S3_MAX_ADAPTIVE_CONCURRENCY", "200"))
DEFAULT_S3_MAX_RETRY_AGE_SECONDS: Final = int(os.getenv("DEFAULT_S3_MAX_RETRY_AGE_SECONDS", "3600"))
