...
replicate_models: frozenset = frozenset(
    [
...
clarifai_models: frozenset = frozenset(
    [
...
huggingface_models: frozenset = frozenset(
    [
...
empower_models: frozenset = frozenset(
    [
...
together_ai_models: frozenset = frozenset(
    [
        # llama llms - chat
...
baseten_models: frozenset = frozenset(
    [
        "qvv0xeq",
        "q841o8w",
        "31dxrj3",
...
open_ai_embedding_models: frozenset = frozenset(["text-embedding-ada-002"])
cohere_embedding_models: frozenset = frozenset(
    [
        "embed-english-v3.0",
...
bedrock_embedding_models: frozenset = frozenset(
    [
