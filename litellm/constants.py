...
DEFAULT_S3_MAX_CONCURRENT_UPLOADS: Final = int(os.getenv("DEFAULT_S3_MAX_CONCURRENT_UPLOADS", "200"))
DEFAULT_S3_INITIAL_CONCURRENT_UPLOADS: Final = int(os.getenv("DEFAULT_S3_INITIAL_CONCURRENT_UPLOADS", "16"))
DEFAULT_S3_MAX_FLUSH_ATTEMPTS: Final = int(os.getenv("DEFAULT_S3_MAX_FLUSH_ATTEMPTS", "10"))
