...
COROUTINE_CHECKER_DEFAULT_TTL = int(os.getenv("COROUTINE_CHECKER_DEFAULT_TTL", 3600))  # 1 hour
COROUTINE_CHECKER_MAX_SIZE_PER_ITEM = int(os.getenv("COROUTINE_CHECKER_MAX_SIZE_PER_ITEM", 1))
