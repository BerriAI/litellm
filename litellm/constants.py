...
# MCP Dominion Observatory trust scoring defaults
DEFAULT_MCP_TRUST_SCORING_API_URL = str(
    os.getenv(
        "DEFAULT_MCP_TRUST_SCORING_API_URL",
        "https://dominionobservatory.com/api/trust",
    )
)
DEFAULT_MCP_TRUST_SCORING_MIN_SCORE = float(
    os.getenv("DEFAULT_MCP_TRUST_SCORING_MIN_SCORE", 0.5)
)
DEFAULT_MCP_TRUST_SCORING_CACHE_TTL = int(
    os.getenv("DEFAULT_MCP_TRUST_SCORING_CACHE_TTL", 3600)
)
MCP_TRUST_SCORING_CACHE_MAX_SIZE = int(
    os.getenv("MCP_TRUST_SCORING_CACHE_MAX_SIZE", 500)
)
