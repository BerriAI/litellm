...
SPEND_LOG_CLEANUP_STARTUP_DELAY_SECONDS: Final = int(os.getenv("SPEND_LOG_CLEANUP_STARTUP_DELAY_SECONDS", "60"))
SPEND_LOG_CLEANUP_STARTUP_JITTER_SECONDS: Final = int(os.getenv("SPEND_LOG_CLEANUP_STARTUP_JITTER_SECONDS", "300"))
