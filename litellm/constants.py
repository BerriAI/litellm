...
PROMETHEUS_RATE_LIMIT_METRICS_REFRESH_INTERVAL_MINUTES = int(
    os.getenv("PROMETHEUS_RATE_LIMIT_METRICS_REFRESH_INTERVAL_MINUTES", 5)
)
...
PROMETHEUS_EMIT_RATE_LIMIT_METRICS_JOB_NAME = "prometheus_emit_rate_limit_metrics"
