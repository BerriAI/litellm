...
MAX_GUARDRAIL_INPUT_LENGTH = int(
    os.getenv("MAX_GUARDRAIL_INPUT_LENGTH", 4096)
)  # Maximum length of input for guardrail processing, if the input length is greater than this, the guardrail check will be skipped
DISABLE_MAX_GUARDRAIL_INPUT_CHECK = bool(
    os.getenv("DISABLE_MAX_GUARDRAIL_INPUT_CHECK", False)
)  # If True, the guardrail check will run on input of all lengths, independent of the MAX_GUARDRAIL_INPUT_LENGTH. Dangerous if the input is very long.
