...
PROMETHEUS_GENERATE_LARGE_TEST_PAYLOAD = bool(
    os.getenv("PROMETHEUS_GENERATE_LARGE_TEST_PAYLOAD", True)
)  # Generate ~34MB of test metrics data on startup for testing large payloads
PROMETHEUS_TEST_PAYLOAD_SIZE_MB = int(
    os.getenv("PROMETHEUS_TEST_PAYLOAD_SIZE_MB", 10)
)  # Target size in MB for test payload generation
