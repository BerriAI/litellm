...
def mock_completion(
    ...
    **kwargs,
    ...
    try:
        ...
        mock_response = cast(Union[str, dict], mock_response)  # after this point, mock_response is a string or dict
...
def completion(  # type: ignore # noqa: PLR0915
    ...
    **kwargs,
    ...
    try:
        ...
        model_info, model = responses_api_bridge_check(model=model, custom_llm_provider=custom_llm_provider)
        ...
        if model_info.get("mode") == "responses":
            ...
            try:
                ...
                verbose_logger.warning(f"Responses API failed, falling back to chat completions: {e}")
    ...
    try:
        ...
        mode_handlers = {
            ...
            "audio_speech": lambda: litellm.aspeech(
                **{
                    **_filter_model_params(model_params),
                    **({"voice": "alloy"} if "voice" not in _filter_model_params(model_params) else {}),
                },
