    ...
    def transform_responses_api_request_to_chat_completion_request(
        ...
        **kwargs,
        ...
        litellm_completion_request: dict = {
            ...
            "stream": stream,
            "metadata": responses_api_request.get("metadata") or kwargs.get("metadata"),
            ...
            "prompt_cache_retention": responses_api_request.get("prompt_cache_retention"),
            "verbosity": text_param.get("verbosity") if isinstance(text_param, dict) else None,
