    ...
    if stream:
        ...
        class MCPStreamingIterator:
            ...
            async def _prepare_follow_up_call(self):
                ...
                # Use the same acompletion reference used for the initial call.
                # This avoids accidental real network calls in tests if patching
                # is applied to `litellm.acompletion`.
