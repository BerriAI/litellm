...
from litellm.llms.komilion.cost_calculator import (
    cost_per_token as komilion_cost_per_token,
)
...
def cost_per_token(  # noqa: PLR0915
    ...
    if call_type == "speech" or call_type == "aspeech":
        ...
        return komilion_cost_per_token(model=model, usage=usage_block)
