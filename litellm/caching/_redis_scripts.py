...
INCREMENT_WITH_FLOOR = """\
-- increment_with_floor
-- Generated by redis-lua-py from redis_scripts/scripts.py:21. Do not edit.
local key = KEYS[1]
...
SET_MAX = """\
-- set_max
-- Generated by redis-lua-py from redis_scripts/scripts.py:32. Do not edit.
...
CLAIM_AFFINITY_PIN = """\
-- claim_affinity_pin
-- Generated by redis-lua-py from redis_scripts/scripts.py:50. Do not edit.
...
LOGIN_BLOCK_TTLS = """\
-- login_block_ttls
-- Generated by redis-lua-py from redis_scripts/scripts.py:99. Do not edit.
...
RECORD_LOGIN_FAILURE = """\
-- record_login_failure
-- Generated by redis-lua-py from redis_scripts/scripts.py:104. Do not edit.
local pair_counter = KEYS[1]
local pair_block = KEYS[2]
local source_counter = KEYS[3]
local source_block = KEYS[4]
...
RESERVE_ENQUEUED_TOKENS = """\
-- reserve_enqueued_tokens
-- Generated by redis-lua-py from redis_scripts/scripts.py:143. Do not edit.
-- Python truthiness: 0, '', empty tables and nil are all false.
local function __truthy(v)
  if v == nil or v == false then return false end
  if v == 0 or v == '' then return false end
...
REFUND_ENQUEUED_TOKENS = """\
-- refund_enqueued_tokens
-- Generated by redis-lua-py from redis_scripts/scripts.py:157. Do not edit.
local key = KEYS[1]
local amount = tonumber(ARGV[1])
...
SAVE_RESERVATION = """\
-- save_reservation
-- Generated by redis-lua-py from redis_scripts/scripts.py:165. Do not edit.
local key = KEYS[1]
local record = ARGV[1]
local ttl = tonumber(ARGV[2])
...
POP_RESERVATION = """\
-- pop_reservation
-- Generated by redis-lua-py from redis_scripts/scripts.py:171. Do not edit.
-- Python truthiness: 0, '', empty tables and nil are all false.
local function __truthy(v)
  if v == nil or v == false then return false end
  if v == 0 or v == '' then return false end
...
INCREMENT_SESSION_ITERATIONS = """\
-- increment_session_iterations
-- Generated by redis-lua-py from redis_scripts/scripts.py:183. Do not edit.
local key = KEYS[1]
local ttl = tonumber(ARGV[1])
...
INCREMENT_SESSION_SPEND = """\
-- increment_session_spend
-- Generated by redis-lua-py from redis_scripts/scripts.py:195. Do not edit.
local key = KEYS[1]
local amount = ARGV[1]
local ttl = tonumber(ARGV[2])
...
DELETE_IF_OWNER = """\
-- delete_if_owner
-- Generated by redis-lua-py from redis_scripts/scripts.py:209. Do not edit.
local key = KEYS[1]
local token = ARGV[1]
...
PEXPIRE_IF_OWNER = """\
-- pexpire_if_owner
-- Generated by redis-lua-py from redis_scripts/scripts.py:217. Do not edit.
local key = KEYS[1]
local token = ARGV[1]
...
BATCH_RATE_LIMIT = """\
-- batch_rate_limit
-- Generated by redis-lua-py from redis_scripts/scripts.py:227. Do not edit.
-- A Redis command with nothing to return hands Lua false, not nil, so an
-- `is None` test has to accept both. Taking v as an argument also means the
-- operand is evaluated once, not once per comparison.
local function __isnil(v)
...
CHECK_AND_INCREMENT_BY_N = """\
-- check_and_increment_by_n
-- Generated by redis-lua-py from redis_scripts/scripts.py:260. Do not edit.
-- Python truthiness: 0, '', empty tables and nil are all false.
local function __truthy(v)
  if v == nil or v == false then return false end
  if v == 0 or v == '' then return false end
...
WINDOW_GUARDED_TOKEN_INCREMENT = """\
-- window_guarded_token_increment
-- Generated by redis-lua-py from redis_scripts/scripts.py:330. Do not edit.
-- Python truthiness: 0, '', empty tables and nil are all false.
local function __truthy(v)
  if v == nil or v == false then return false end
  if v == 0 or v == '' then return false end
...
PARALLEL_ACQUIRE = """\
-- parallel_acquire
-- Generated by redis-lua-py from redis_scripts/scripts.py:359. Do not edit.
local keys = {}
for __i1 = 1, #KEYS do
  keys[#keys + 1] = KEYS[__i1]
end
...
PARALLEL_RELEASE = """\
-- parallel_release
-- Generated by redis-lua-py from redis_scripts/scripts.py:391. Do not edit.
local keys = {}
for __i1 = 1, #KEYS do
  keys[#keys + 1] = KEYS[__i1]
end
...
PARALLEL_COUNT = """\
-- parallel_count
-- Generated by redis-lua-py from redis_scripts/scripts.py:406. Do not edit.
local keys = {}
for __i1 = 1, #KEYS do
  keys[#keys + 1] = KEYS[__i1]
end
...
INCREMENT_TOKENS = """\
-- increment_tokens
-- Generated by redis-lua-py from redis_scripts/scripts.py:417. Do not edit.
local keys = {}
for __i1 = 1, #KEYS do
  keys[#keys + 1] = KEYS[__i1]
end
