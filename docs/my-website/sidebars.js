...
const sidebars = {
  ...
  integrationsSidebar: [
    ...
    },
    {
      ...
      items: ["proxy/alerting", "proxy/pagerduty", "proxy/prometheus"],
    },
    {
      type: "category",
...

    {
      ...
      items: [
        ...
        },
        {
          type: "category",
          label: "Configuration",
          items: ["set_keys", "caching/all_caches"],
        },
      ...
      items: [
        {
          ...
          items: ["a2a", "a2a_cost_tracking", "a2a_agent_permissions"],
        },
        "assistants",
        {
          type: "category",
        ...
        },
        {
          type: "category",
          label: "/fine_tuning",
          items: ["fine_tuning", "proxy/managed_finetuning"],
        },
        "generateContent",
        "apply_guardrail",
        "bedrock_invoke",
        "interactions",
        {
          type: "category",
          label: "/images",
          items: ["image_edits", "image_generation", "image_variations"],
        },
        "videos",
        "vector_store_files",
        {
        ...
        "rerank",
        {
          type: "category",
          label: "/responses",
          items: ["response_api", "response_api_compact"],
        },
        {
          type: "category",
          label: "/search",
        ...
        "skills",
        {
          type: "category",
          label: "/vector_stores",
          items: ["vector_stores/create", "vector_stores/search"],
        },
      ],
    },
    {
      ...
      items: [
        ...
        "providers/heroku",
        {
          type: "category",
          label: "HuggingFace",
          items: ["providers/huggingface", "providers/huggingface_rerank"],
        },
        ...
        { type: "doc", id: "providers/nscale", label: "Nscale (EU Sovereign)" },
        {
          type: "category",
          label: "Nvidia NIM",
          items: ["providers/nvidia_nim", "providers/nvidia_nim_rerank"],
        },
        "providers/oci",
        "providers/ollama",
        ...
        "providers/replicate",
        {
          type: "category",
          label: "RunwayML",
          items: ["providers/runwayml/images", "providers/runwayml/videos"],
        },
        "providers/sambanova",
        "providers/sap",
        "providers/stability",
