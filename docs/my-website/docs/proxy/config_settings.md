...
general_settings:
  ...
  model_cost_map_reload_interval: 21600  # interval in seconds for automatic price data reload (default: 6 hours, set to 0 to disable)
...
| model_cost_map_reload_interval | integer | Interval in seconds for automatic price data reload (default: 21600 seconds/6 hours, set to 0 to disable) [Doc on Price Data Reload](./price_data_reload.md) |
