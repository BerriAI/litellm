...
general_settings:
  ...
  maximum_retention_period: Union[int, str] | The maximum time to retain spend logs before deletion. Can be specified in days (e.g., "30d"), hours (e.g., "24h"), minutes (e.g., "60m"), seconds (e.g., "3600s" or just "3600"), weeks (e.g., "1w"), or months (e.g., "1mo"). If not set, logs will be retained indefinitely.
