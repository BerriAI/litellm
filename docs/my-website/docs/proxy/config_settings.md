...
| MAVVRIK_LOOKBACK_DAYS | First-run lookback window in days for Mavvrik exports. Unset (default) exports all data since the earliest row in `LiteLLM_DailyUserSpend`
