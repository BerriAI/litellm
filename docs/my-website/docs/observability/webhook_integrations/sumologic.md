...
Sumo Logic is a cloud-native machine data analytics platform. Send LLM logs to Sumo Logic for centralized logging and analysis.
 [Learn more about Sumo Logic](https://www.sumologic.com/).
...
- ❌ **Failure events** (`llm_api_failure`)

## Environment Variables

| Variable | Description | Required |
|----------|-------------|----------|
| `SUMOLOGIC_WEBHOOK_URL` | Webhook endpoint URL | Yes |

:::tip Setup Note

Create an HTTP Source in Sumo Logic and use the provided URL as `SUMOLOGIC_WEBHOOK_URL`. No additional API key is required as authentication is embedded in the URL.
...
environment_variables:
  SUMOLOGIC_WEBHOOK_URL: "your-value-here"
```
...
os.environ["SUMOLOGIC_WEBHOOK_URL"] = "your-value-here"
os.environ["OPENAI_API_KEY"] = "your-openai-key"

# Enable the callback
litellm.success_callback = ["sumologic"]
litellm.failure_callback = ["sumologic"]
