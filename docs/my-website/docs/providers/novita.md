# Novita AI
LiteLLM supports all models from [Novita AI](https://novita.ai/model-api/product/llm-api?utm_source=github_litellm&utm_medium=github_readme&utm_campaign=github_link)
