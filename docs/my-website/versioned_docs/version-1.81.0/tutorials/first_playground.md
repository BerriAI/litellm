...
<Image
  img={require('@site/img/litellm_streamlit_playground.png')}
...
<Image img={require('@site/img/test_python_server_2.png')} alt="python_code_sample_2" />
...
This is what you should see: 
<Image img={require('@site/img/litellm_streamlit_playground.png')} alt="streamlit_playground" />
