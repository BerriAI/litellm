...
<Image img={require('@site/img/litellm_create_team.gif')} />
...
<Image img={require('@site/img/create_key_in_team_oweb.gif')} />
...
<Image img={require('@site/img/litellm_setup_openweb.gif')} />
...
<Image img={require('@site/img/basic_litellm.gif')} />
...
<Image img={require('@site/img/custom_tag_headers.png')} />