...
<Image img={require('@site/img/scim_2.png')}  style={{ width: '800px', height: 'auto' }} />
...
<Image img={require('@site/img/scim_4.png')}  style={{ width: '800px', height: 'auto' }} />
...
<Image img={require('@site/img/msft_enterprise_app.png')}  style={{ width: '800px', height: 'auto' }} />
...
<Image img={require('@site/img/msft_enterprise_assign_group.png')}  style={{ width: '800px', height: 'auto' }} />
...
<Image img={require('@site/img/msft_enterprise_select_group.png')}  style={{ width: '800px', height: 'auto' }} />
...
<Image img={require('@site/img/msft_sso_sign_in.png')}  style={{ width: '800px', height: 'auto' }} />
...
<Image img={require('@site/img/msft_auto_team.png')}  style={{ width: '900px', height: 'auto' }} />
