...
1. **Create a team**  
   ...
   <Image img={require('@site/img/secret_manager_settings_create_team.png')} />

2. **Expand Additional Settings**  
   Use the `Additional Settings` toggle to reveal the advanced configuration panel.  
   
  <Image img={require('@site/img/secret_manager_settings_additional_settings.png')} />
...
3. **Configure the Secret Manager**  
   ...
   <Image img={require('@site/img/secret_manager_settings.png')} />

4. **Create the team**  
   Review the inputs and click `Create Team` to save.  
   
   <Image img={require('@site/img/secret_manager_settings_create_button.png')} />
