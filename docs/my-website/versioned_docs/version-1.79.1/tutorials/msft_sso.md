...
<Image img={require('@site/img/litellm_entra_id.png')}  style={{ width: '800px', height: 'auto' }} />
...
<Image img={require('@site/img/entra_create_team.png')}  style={{ width: '800px', height: 'auto' }} />
...
<Image img={require('@site/img/msft_member_1.png')}  style={{ width: '800px', height: 'auto' }} />
...
<Image img={require('@site/img/msft_member_2.png')}  style={{ width: '800px', height: 'auto' }} />
...
<Image img={require('@site/img/msft_member_3.png')}  style={{ width: '900px', height: 'auto' }} />
...
<Image img={require('@site/img/msft_default_settings.png')}  style={{ width: '900px', height: 'auto' }} />
