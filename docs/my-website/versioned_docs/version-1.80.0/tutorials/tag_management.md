...
<Image img={require('@site/img/tag_create.png')}  style={{ width: '800px', height: 'auto' }} />
...
<Image img={require('@site/img/tag_invalid.png')}  style={{ width: '800px', height: 'auto' }} />
...
<Image img={require('@site/img/tag_valid.png')}  style={{ width: '800px', height: 'auto' }} />
