---
title: "[Preview] v1.81.12 - Guardrail Pipelines, MCP OAuth2 M2M, Scaleway Provider"
slug: "v1-81-12"
...
- **Guardrail Pipelines & Policy Templates** - [Add conditional sequential execution for guardrail pipelines and pre-configured policy templates for NSFW, toxic content, and child safety filtering](../../docs/proxy/guardrails)
- **MCP OAuth2 M2M + Discovery UI + Tracing** - [Machine-to-machine OAuth2 for MCP servers, a discovery UI for browsing available MCP servers, and OpenTelemetry tracing for MCP calls](../../docs/mcp)
- **Scaleway Provider** - [New Scaleway provider for chat completions](../../docs/providers/scaleway)
- **Responses API Enhancements** - [Server-side context management (compaction) and Shell tool support for the OpenAI Responses API](../../docs/response_api)
...
- **60+ New Bedrock Models** - DeepSeek V3.2, MiniMax M2.1, Kimi K2.5, Qwen3 Coder Next, and NVIDIA Nemotron Nano across multiple regions
- **Perplexity Research API** - [Use Perplexity's Research API with preset search and provider-specific model routing](../../docs/providers/perplexity)
...
#### New Model Support (30+ new models)
...
## Documentation Updates (12 updates)
