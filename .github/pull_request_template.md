<!-- Plain English please. Describe the change the way you would explain it to a teammate who has not seen the code: what it does and why, not which functions, files, or tables it touches
     Drop every section you have nothing to put in, heading included: a bare heading with nothing under it must not appear in the final description -->
...
<!-- Major ones only: behavior that breaks on purpose, migrations that lock tables, auth changes, known gaps you did not fix. Drop the section if there are none -->

## Linear ticket

<!-- Internal contributors: Resolves LIT-1234. Otherwise drop the section -->
