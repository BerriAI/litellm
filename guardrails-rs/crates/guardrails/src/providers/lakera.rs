...
use crate::{
    Detection, Guardrail, GuardrailInput, GuardrailOutcome, InputType, LakeraV2Config, OnFlagged,
...
impl LakeraV2 {
    pub fn new(config: LakeraV2Config, http: Arc<HttpClient>) -> Self {
        Self { config, http }
    }
    ...
    fn api_key(&self) -> Result<String, ProviderError> {
        ...
        std::env::var("LAKERA_API_KEY").map_err(|_| ProviderError::InvalidConfig {
