...
help:
	...
	@echo "  make lint-budget-update - Re-capture all ratchet budgets (ruff + basedpyright + any)"
...
# Ratchet all budgets in one shot (ruff strict + basedpyright + any)
lint-budget-update: lint-ruff-budget-update lint-basedpyright-budget-update lint-any-budget-update
...
lint: format-check lint-ruff lint-basedpyright check-circular-imports check-import-safety lint-ruff-budget lint-any

# Faster linting for local development (only checks changed code)
lint-dev: lint-format-changed lint-any check-circular-imports check-import-safety
