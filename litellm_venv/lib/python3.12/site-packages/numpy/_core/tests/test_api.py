...
def test_array_array():
    ...
    o = type("o", (object,), {"__array_interface__": a.__array_interface__})
    ...
    o = type("o", (object,), {"__array_struct__": a.__array_struct__})
...
def test_copyto_cast_safety():
    ...
    with pytest.raises(TypeError):
        np.copyto(np.arange(3.0, dtype="float32"), 3.0, casting="equiv")
