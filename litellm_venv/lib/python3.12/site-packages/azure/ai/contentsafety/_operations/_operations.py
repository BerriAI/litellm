...
def build_content_safety_analyze_text_request(
    **kwargs: Any,
...
def build_content_safety_analyze_image_request(
    **kwargs: Any,
) -> HttpRequest:  # pylint: disable=name-too-long
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_blocklist_get_text_blocklist_item_request(  # pylint: disable=name-too-long
    ...
    path_format_arguments = {
        "blocklistName": _SERIALIZER.url("blocklist_name", blocklist_name, "str"),
        "blocklistItemId": _SERIALIZER.url(
            "blocklist_item_id", blocklist_item_id, "str"
        ),
    }
...
def build_blocklist_list_text_blocklists_request(
    **kwargs: Any,
) -> HttpRequest:  # pylint: disable=name-too-long
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
