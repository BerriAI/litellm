...
class DefaultAzureCredential(ChainedTokenCredential):
    ...
    def __init__(
        ...
        interactive_browser_client_id = kwargs.pop(
            "interactive_browser_client_id", None
        )
        ...
        exclude_interactive_browser_credential = kwargs.pop(
        ...
        if not exclude_interactive_browser_credential:
            if interactive_browser_client_id:
                ...
                credentials.append(
                    InteractiveBrowserCredential(
                        tenant_id=interactive_browser_tenant_id, **kwargs
                    )
                )
