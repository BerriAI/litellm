...
class DataLakeFileClient(PathClient):
    ...
    def create_file(
        ...
        **kwargs: Any,
        ...
        """
        return self._create(
            "file", content_settings=content_settings, metadata=metadata, **kwargs
        )
    ...
    def get_file_properties(self, **kwargs: Any) -> FileProperties:
        ...
        return cast(
            FileProperties,
            self._get_path_properties(cls=deserialize_file_properties, **kwargs),
        )
    ...
    def set_file_expiry(
        ...
        **kwargs: Any,
        ...
        self._datalake_client_for_blob_operation.path.set_expiry(
            expiry_options, expires_on=expiry_time, **kwargs
        )
    ...
    def append_data(
        ...
        **kwargs: Any,
        ...
        options = _append_data_options(
            data=data, offset=offset, scheme=self.scheme, length=length, **kwargs
        )
        try:
    ...
    def download_file(
        ...
        downloader = self._blob_client.download_blob(
            offset=offset, length=length, **kwargs
        )
    ...
    @distributed_trace
    def query_file(
        self, query_expression: str, **kwargs: Any
        ...
        """
        query_expression = query_expression.replace(
            "from DataLakeStorage", "from BlobStorage"
        )
