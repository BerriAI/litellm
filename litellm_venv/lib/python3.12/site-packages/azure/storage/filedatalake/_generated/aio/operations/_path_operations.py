...
class PathOperations:
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        cls: ClsType[Optional[_models.SetAccessControlRecursiveResponse]] = kwargs.pop(
            "cls", None
        )
        ...
        if response.status_code == 200:
            ...
            deserialized = self._deserialize(
                "SetAccessControlRecursiveResponse", pipeline_response.http_response
            )
        ...
        **kwargs: Any
        ...
        if response.status_code == 202:
            ...
            response_headers["x-ms-lease-time"] = self._deserialize(
                "str", response.headers.get("x-ms-lease-time")
            )
        ...
        **kwargs: Any
        ...
        if response.status_code == 206:
            ...
            response_headers["x-ms-content-md5"] = self._deserialize(
                "str", response.headers.get("x-ms-content-md5")
            )
            response_headers["Date"] = self._deserialize(
                "rfc-1123", response.headers.get("Date")
            )
    ...
    async def get_properties(
        ...
        **kwargs: Any
        ...
        response_headers["x-ms-owner"] = self._deserialize(
            "str", response.headers.get("x-ms-owner")
        )
        response_headers["x-ms-group"] = self._deserialize(
            "str", response.headers.get("x-ms-group")
        )
        response_headers["x-ms-permissions"] = self._deserialize(
            "str", response.headers.get("x-ms-permissions")
        )
        response_headers["x-ms-acl"] = self._deserialize(
            "str", response.headers.get("x-ms-acl")
        )
        response_headers["x-ms-lease-duration"] = self._deserialize(
            "str", response.headers.get("x-ms-lease-duration")
        )
    ...
    async def delete(
        ...
        **kwargs: Any
        ...
        if response.status_code == 200:
            ...
            response_headers["x-ms-deletion-id"] = self._deserialize(
                "str", response.headers.get("x-ms-deletion-id")
            )
    ...
    async def set_access_control(
        ...
        **kwargs: Any
        ...
        action: Literal["setAccessControl"] = kwargs.pop(
            "action", _params.pop("action", "setAccessControl")
        )
        cls: ClsType[None] = kwargs.pop("cls", None)
    ...
    async def set_access_control_recursive(
        ...
        **kwargs: Any
        ...
        cls: ClsType[_models.SetAccessControlRecursiveResponse] = kwargs.pop(
            "cls", None
        )
    ...
    async def flush_data(
        ...
        **kwargs: Any
        ...
        response_headers["x-ms-lease-renewed"] = self._deserialize(
            "bool", response.headers.get("x-ms-lease-renewed")
        )
    ...
    async def append_data(
        ...
        **kwargs: Any
        ...
        action: Literal["append"] = kwargs.pop(
            "action", _params.pop("action", "append")
        )
        content_type: str = kwargs.pop(
