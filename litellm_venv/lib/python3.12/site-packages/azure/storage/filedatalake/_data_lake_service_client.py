...
class DataLakeServiceClient(StorageAccountHostsMixin):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._blob_service_client = BlobServiceClient(
            blob_account_url, credential, **kwargs
        )
    ...
    def get_user_delegation_key(
        ...
        delegation_key = self._blob_service_client.get_user_delegation_key(
            key_start_time=key_start_time, key_expiry_time=key_expiry_time, **kwargs
        )
        return UserDelegationKey._from_generated(
            delegation_key
    ...
    def list_file_systems(
        ...
        **kwargs: Any
        ...
        item_paged._page_iterator_class = (
            FileSystemPropertiesPaged  # pylint: disable=protected-access
        )
    ...
    def _rename_file_system(
        ...
        :rtype: ~azure.storage.filedatalake.FileSystemClient
        """
        self._blob_service_client._rename_container(
            name, new_name, **kwargs
        )  # pylint: disable=protected-access
    ...
    def undelete_file_system(
        self, name: str, deleted_version: str, **kwargs: Any
    ) -> FileSystemClient:
