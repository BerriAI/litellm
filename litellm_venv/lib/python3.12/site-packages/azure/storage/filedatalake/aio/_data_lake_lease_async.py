...
class DataLakeLeaseClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    async def change(self, proposed_lease_id: str, **kwargs: Any) -> None:
        ...
        :return: None
        """
        await self._blob_lease_client.change(
            proposed_lease_id=proposed_lease_id, **kwargs
        )
        self._update_lease_client_attributes()
    ...
    async def break_lease(
        ...
        :rtype: int
        """
        return await self._blob_lease_client.break_lease(
            lease_break_period=lease_break_period, **kwargs
        )
