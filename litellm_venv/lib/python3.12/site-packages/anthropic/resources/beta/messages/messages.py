...
from ....types.beta.beta_request_mcp_server_url_definition_param import (
...
class Messages(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        if (
            not stream
            and not is_given(timeout)
            and self._client.timeout == DEFAULT_TIMEOUT
        ):
        ...
        *,
        ...
        extra_headers = {
            **strip_not_given(
                {
                    "anthropic-beta": ",".join(
                        chain((str(e) for e in betas), ["token-counting-2024-11-01"])
                    )
                    if is_given(betas)
                    else NOT_GIVEN
                }
