...
class PolicyBindingsClientMeta(type):
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[PolicyBindingsTransport]]
...
class PolicyBindingsClient(metaclass=PolicyBindingsClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = PolicyBindingsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = PolicyBindingsClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = PolicyBindingsClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or PolicyBindingsClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                Type[PolicyBindingsTransport], Callable[..., PolicyBindingsTransport]
            ] = (
    ...
    def search_target_policy_bindings(
        ...
        *,
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.search_target_policy_bindings
        ]
