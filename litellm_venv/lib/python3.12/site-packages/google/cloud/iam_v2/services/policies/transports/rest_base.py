...
class _BasePoliciesRestTransport(PoliciesTransport):
    ...
    class _BaseCreatePolicy:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BasePoliciesRestTransport._BaseCreatePolicy._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseDeletePolicy:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BasePoliciesRestTransport._BaseDeletePolicy._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseGetPolicy:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BasePoliciesRestTransport._BaseGetPolicy._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseListPolicies:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BasePoliciesRestTransport._BaseListPolicies._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseUpdatePolicy:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BasePoliciesRestTransport._BaseUpdatePolicy._get_unset_required_fields(
                    query_params
                )
            )
...
__all__ = ("_BasePoliciesRestTransport",)
