...
class ListPrincipalAccessBoundaryPoliciesPager:
    ...
    :class:`google.cloud.iam_v3.types.ListPrincipalAccessBoundaryPoliciesResponse` object, and
    ...
    All the usual :class:`google.cloud.iam_v3.types.ListPrincipalAccessBoundaryPoliciesResponse`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.iam_v3.types.ListPrincipalAccessBoundaryPoliciesRequest):
                The initial request object.
            response (google.cloud.iam_v3.types.ListPrincipalAccessBoundaryPoliciesResponse):
...
class SearchPrincipalAccessBoundaryPolicyBindingsPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.iam_v3.types.SearchPrincipalAccessBoundaryPolicyBindingsResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ...
    All the usual :class:`google.cloud.iam_v3.types.SearchPrincipalAccessBoundaryPolicyBindingsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.iam_v3.types.SearchPrincipalAccessBoundaryPolicyBindingsRequest):
                The initial request object.
            response (google.cloud.iam_v3.types.SearchPrincipalAccessBoundaryPolicyBindingsResponse):
                The initial response object.
            retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
            timeout (float): The timeout for this request.
