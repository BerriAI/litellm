...
class Certificates(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.OptionalNamedType(
            "aC",
            univ.SequenceOf(componentType=AttributeCertificate())
...
class GLAdministration(univ.Integer):
    namedValues = namedval.NamedValues(("unmanaged", 0), ("managed", 1), ("closed", 2))
...
class GLUseKEK(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.DefaultedNamedType(
            "glAdministration", GLAdministration().subtype(value=1)
        ),
...
id_cmc_glaRR = univ.ObjectIdentifier(
    (
        1,
        3,
        6,
...
id_cet_skdFailInfo = univ.ObjectIdentifier(
    (
        1,
        3,
        6,
