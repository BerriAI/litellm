...
DirectoryString.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        "utf8String",
        char.UTF8String().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, 255)),
    ),
    namedtype.NamedType(
        "bmpString",
        char.BMPString().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, 255)),
    ),
)
...
PKCS9String.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        "ia5String",
        char.IA5String().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, 255)),
    ),
