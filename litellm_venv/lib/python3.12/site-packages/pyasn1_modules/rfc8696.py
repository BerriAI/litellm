...
class KeyTransPSKRecipientInfo(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.NamedType("kdfAlgorithm", rfc5652.KeyDerivationAlgorithmIdentifier()),
        namedtype.NamedType(
            "keyEncryptionAlgorithm", rfc5652.KeyEncryptionAlgorithmIdentifier()
        ),
...
class CMSORIforPSKOtherInfo(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.NamedType(
            "keyMgmtAlgType",
            univ.Enumerated(
                namedValues=namedval.NamedValues(("keyTrans", 5), ("keyAgree", 10))
            ),
        ),
        namedtype.NamedType(
            "keyEncryptionAlgorithm", rfc5652.KeyEncryptionAlgorithmIdentifier()
