...
# Build Admin UI before syncing so the packaged assets are current.
...
# Replace the nodejs-wheel-binaries bundled node with the system node.
...
# Patch npm copies bundled inside nodejs-wheel-binaries as well.
