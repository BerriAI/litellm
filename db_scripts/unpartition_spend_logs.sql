...
ALTER INDEX IF EXISTS "LiteLLM_SpendLogs_api_key_startTime_spend_idx"
    RENAME TO "LiteLLM_SpendLogs_partitioned_api_key_startTime_spend_idx";
...
CREATE INDEX IF NOT EXISTS "LiteLLM_SpendLogs_api_key_startTime_spend_idx"
    ON "LiteLLM_SpendLogs" ("api_key", "startTime", "spend");
