...
use crate::ocr::integrations::{MappedParams, OcrIntegration};
use crate::ocr::types::OcrConnection;
use crate::ocr::wire::{OcrWireRequest, decode_request, decode_response};
use crate::ocr::{OcrClient, OcrRequest, OcrResponseData};
...
pub(crate) async fn perform_ocr(request: OcrRequest) -> Result<OcrResponseData, crate::Error> {
