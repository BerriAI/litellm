...
/// Fully-resolved guardrail provider config. The host builds one of these from
/// the raw guardrail params (resolving secrets and files) before dispatching.
...
pub enum ProviderConfig {
    ...
    #[serde(rename = "local_pii")]
    LocalPii(LocalPiiConfig),
}
