...
macro_rules! bridge_route {
    (
        ...
        #[pyfunction]
        #[pyo3(signature = ($($required_name),*, $($optional_name=None),* $(, *, $($keyword_name=None),*)?))]
        ...
        mod trace {
            use pyo3::prelude::*;
            use super::{$inputs, $map_error, $prepare $(, $context)?};
        ...
        Python::attach(|py| {
            ...
            let routes = [
                (
                    "ocr",
                    "aocr",
                    "(model, document, api_key=None, api_base=None, custom_llm_provider=None, extra_headers=None, optional_params=None, timeout_seconds=None, litellm_call_id=None, *, callback_adapter=None)",
                ),
                (
                    "transcription",
                    "atranscription",
                    "(model, audio, api_key=None, api_base=None, custom_llm_provider=None, extra_headers=None, optional_params=None, timeout_seconds=None, callback_adapter=None)",
                ),
                (
                    "messages",
                    "amessages",
                    "(model, body, api_key=None, api_base=None, custom_llm_provider=None, extra_headers=None, timeout_seconds=None, callback_adapter=None)",
                ),
                (
                    "chat_completions",
                    "achat_completions",
