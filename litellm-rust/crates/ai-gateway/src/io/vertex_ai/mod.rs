...
pub struct VertexAiBase {
    cache: Mutex<BoundedCache<AccessTokenCredentials>>,
}

impl VertexAiBase {
    pub fn new() -> Self {
        Self {
            cache: Mutex::new(BoundedCache::new(VERTEX_CREDENTIALS_CACHE_CAPACITY)),
        }
    }
    ...
    pub fn resolve_credential_source(
        ...
        Self::credential_source_param(optional_params).or_else(|| {
