...
| litellm-gateway-auth | Shared gateway authentication extractors and credential hashing. |
...
config, core, and gateway auth, and the Python bridge depends on the domain
layers and Python interop.
