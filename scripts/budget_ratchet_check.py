...
The `*-budget.json` files (ruff-strict-budget.json, type-discipline-budget.json) are
one-way ratchets: each rule's ceiling is `baseline + slack`, and the whole point is
