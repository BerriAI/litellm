...
async def test_sse_mcp_handler_mock():
    ...
    with (
        ...
        mock_sse_session_manager.handle_request.assert_called_once_with(mock_scope, mock_receive, mock_send)
...
async def test_rest_listing_hides_key_grants_dispatch_would_refuse():
    ...
    with (
        ...
        patch("litellm.proxy._experimental.mcp_server.server.global_mcp_server_manager") as mock_server_manager,
        patch.object(
            MCPRequestHandler,
...
async def test_filter_tools_by_allowed_tools_integration():
    ...
    with patch("litellm.proxy._experimental.mcp_server.server.global_mcp_server_manager") as mock_manager:
...
async def test_call_mcp_tool_uses_manager_permission_lookup():
    ...
    with (
        ...
        patch("litellm.proxy._experimental.mcp_server.server.global_mcp_tool_registry") as mock_tool_registry,
        patch(
