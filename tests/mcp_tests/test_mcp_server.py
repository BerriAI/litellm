...
async def test_get_tools_from_mcp_servers():
    ...
    try:
        ...
        mock_manager.get_mcp_servers_from_ids = MagicMock(
            return_value=[mock_server_1, mock_server_2]
        )
        ...
        with patch(
            ...
            mock_manager_2.get_mcp_servers_from_ids = MagicMock(
                return_value=[mock_server_1, mock_server_2]
            )
        ...
        mock_manager.get_mcp_servers_from_ids = MagicMock(
            return_value=[mock_server_1, mock_server_2, mock_server_3]
        )
        mock_manager._get_tools_from_server = AsyncMock(return_value=[mock_tool_1])
...
async def test_filter_tools_by_allowed_tools_integration():
    ...
    with patch(
        ...
        with patch(
            ...
            mock_manager.get_mcp_servers_from_ids.assert_called_once_with(
                ["test-server-123"]
            )
