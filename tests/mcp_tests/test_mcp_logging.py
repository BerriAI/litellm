    ...
    with patch(
        ...
        with patch(
            ...
            print(
                ...
                json.dumps(logged_standard_logging_payload, indent=4),
            )
    ...
    with patch(
        ...
        with patch(
            ...
            print(
                ...
                json.dumps(logged_standard_logging_payload_1, indent=4),
            )
            ...
            print(
                ...
                json.dumps(logged_standard_logging_payload_2, indent=4),
            )
