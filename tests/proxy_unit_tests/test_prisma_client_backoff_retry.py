...
class TestPrismaClientBackoffRetry:
    ...
    @pytest.mark.asyncio
    async def test_get_spend_logs_row_count_retry_then_success(self, mock_prisma_client, mock_proxy_logging, connection_errors):
    ...
    @pytest.mark.asyncio
    async def test_set_spend_logs_row_count_retry_behavior(self, mock_prisma_client, mock_proxy_logging, connection_errors):
