...
backend is a secret_store_<system>.py module, its entry here, and
gateway/secret_manager_<system>_ci_config.yml; the tests and markers stay as they are.
"""
...
BACKENDS: Final = MappingProxyType({backend.system: backend for backend in (HASHICORP_VAULT,)})
