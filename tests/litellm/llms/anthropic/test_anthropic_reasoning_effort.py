...
class TestMapReasoningEffort:
    ...
    def test_opus_4_6_dotted_alias_supports_reasoning_effort_param(self):
        params = AnthropicConfig().get_supported_openai_params(
            model="claude-opus-4.6-20260205"
        )
        assert "reasoning_effort" in params

    def test_sonnet_4_6_dotted_alias_supports_reasoning_effort_param(self):
        params = AnthropicConfig().get_supported_openai_params(
