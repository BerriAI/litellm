...
def test_new_request_creation(client, base_url, api_key):
    ...
    # Check request body
    assert request.json == {"model_name": model_name, "litellm_params": model_params, "model_info": model_info}
...
def test_get_success_by_name(client, requests_mock):
    ...
    mock_models = {
        "data": [
            {"model_name": model_name, "model_info": {"id": "model-123"}, "litellm_params": {"model": "openai/gpt-4"}}
        ]
    }
...
def test_update_request_creation(client, base_url, api_key):
    ...
    # Check request body
    assert request.json == {"id": model_id, "litellm_params": model_params, "model_info": model_info}
