...
IGNORE_FUNCTIONS = [
    ...
    "_with_stored_leaves",  # max depth set (_MASKED_READ_BACK_DEPTH=20, the depth _get_masked_values masks a read-back under); passes the value through untouched at the cap.
