...
IGNORE_FUNCTIONS = [
    ...
    "_with_stored_leaves",  # max depth set (_MASKED_READ_BACK_DEPTH=20, the cap _get_masked_values masked the read-back under); passes the value through untouched at the cap.
