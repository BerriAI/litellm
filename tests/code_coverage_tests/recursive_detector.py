...
IGNORE_FUNCTIONS = [
    ...
    "_resolve",  # OCI schema $ref inliner — bounded by explicit cycle-detection stack (resolving_stack).
    "resolve_oci_schema_anyof",  # max depth set.
    "sanitize_oci_schema",  # max depth set.
]
