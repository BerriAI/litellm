...
@pytest.mark.asyncio
async def testread_request_body_valid_json():
    ...
    request = MockRequest()
    result = await read_request_body(request)
    assert result == {"key": "value"}


@pytest.mark.asyncio
async def testread_request_body_empty_body():
...
@pytest.mark.asyncio
async def testread_request_body_invalid_json():
...
@pytest.mark.asyncio
async def testread_request_body_large_payload():
...
@pytest.mark.asyncio
async def testread_request_body_unexpected_error():
