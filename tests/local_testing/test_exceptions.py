...
def test_context_window_with_fallbacks(model):
    ctx_window_fallback_dict = {
        ...
        "azure/gpt-4o-new-test": "gpt-3.5-turbo-16k",
    }
...
def invalid_auth(model):  # set the model key to an invalid key, depending on the model
    ...
    try:
        ...
        elif model == "azure/gpt-4o-new-test":
...
# extended_models = ["azure/gpt-4o-new-test" for _ in range(250)]
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("azure", "azure/gpt-4o-new-test", "chat_completion", True),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("model", ["azure/gpt-4o-new-test", "openai/gpt-3.5-turbo"])
