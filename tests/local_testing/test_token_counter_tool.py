...
@pytest.mark.parametrize(
    "messages",
    [MESSAGE_CHAIN, MESSAGE_CHAIN_NO_FUNCTION, MESSAGE_CHAIN_FAILS_NO_FUNCTION_ARGS, 
    ...
    ids=["MESSAGE_CHAIN", "MESSAGE_CHAIN_NO_FUNCTION", "MESSAGE_CHAIN_FAILS_NO_FUNCTION_ARGS", 
         "MESSAGE_CHAIN_WORKS", "MESSAGE_ORIGINAL_LONG", "SYSTEM_SHORT_AND_TOOL",
         "SYSTEM_SHORTER_AND_TOOL", "SYSTEM_SHORTER_AND_TOOL_NO_CONTENT", "SYSTEM_AND_TOOL_SHORT_CONTENT"],
)
