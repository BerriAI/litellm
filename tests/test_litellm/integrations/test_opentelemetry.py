...
class TestOpenTelemetrySemanticConventions138(unittest.TestCase):
    ...
    def test_input_messages_with_array_content_normalizes_text_key_to_content(self):
        ...
        input_calls = [c for c in mock_span.set_attribute.call_args_list if c[0][0] == "gen_ai.input.messages"]
    ...
    def test_anthropic_system_blocks_hoisted_into_single_system_role(self):
        ...
        sys_calls = [c for c in mock_span.set_attribute.call_args_list if c[0][0] == "gen_ai.system_instructions"]
