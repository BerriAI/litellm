...
class TestDataDogLLMObsBatchSplit:
    ...
    async def test_413_retries_with_smaller_chunks(self):
        ...
        # Force _exceeds_intake_limits to return False so the first POST
        # goes through and gets a 413 from the server side.
        with patch.object(
            DataDogLLMObsLogger, "_exceeds_intake_limits", return_value=False
