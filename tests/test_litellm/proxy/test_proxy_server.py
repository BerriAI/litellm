...
@pytest.mark.asyncio
async def test_get_v1_model_info_allowed_names_includes_inherited_team_access_group_models():
    ...
    with patch.object(
        ...
        result = await proxy_server_module._get_v1_model_info_allowed_model_names(
...
@pytest.mark.asyncio
async def test_get_v1_model_info_allowed_names_does_not_broaden_empty_access_group():
    from litellm.proxy._types import SpecialModelNames, UserAPIKeyAuth
