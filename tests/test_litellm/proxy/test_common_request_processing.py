...
async def test_completion_model_fallback_logic(monkeypatch):
    ...
    # 1. Request has a model, general_settings has completion_model
    ...
    # 2. Request has NO model, general_settings has completion_model
    ...
    # 3. user_model (CLI) is provided — should win over everything.
