...
def _no_prisma():
    return patch(  # test-quality-ok: replace the optional dependency import seam
...
def test_prisma_classifiers_without_prisma_are_safe():
    classifiers = (
        ...
        PrismaDBExceptionHandler.is_prisma_error,
