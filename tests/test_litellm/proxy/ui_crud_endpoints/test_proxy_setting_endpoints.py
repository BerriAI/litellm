...
class TestProxySettingEndpoints:
    ...
    def test_update_ui_theme_settings_with_dark_logo(self, mock_proxy_config, mock_auth, monkeypatch):
    ...
    def test_update_ui_theme_settings_rejects_local_path_dark_logo(self, mock_proxy_config, mock_auth, monkeypatch):
    ...
    def test_get_ui_theme_settings_surfaces_dark_logo_from_process_env(self, mock_proxy_config, monkeypatch):
...
class TestWebSearchInterceptionSettingsEndpoints:
    ...
    def test_get_flags_a_pod_that_has_not_applied_the_stored_setting(self, mock_proxy_config, mock_auth, monkeypatch):
        import litellm
