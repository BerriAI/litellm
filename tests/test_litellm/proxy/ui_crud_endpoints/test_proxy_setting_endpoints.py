...
class TestProxySettingEndpoints:
    ...
    def test_setup_all_sso_mappings_role_mappings_with_env_vars(self, monkeypatch):
        """Test _setup_all_sso_mappings loads role mappings from environment variables"""
        import asyncio

        from litellm.proxy._types import LitellmUserRoles
        from litellm.proxy.management_endpoints.ui_sso import _setup_all_sso_mappings
        ...
        role_mappings, _team_mappings, _attr_mappings = asyncio.run(
    ...
    def test_setup_all_sso_mappings_returns_none_with_no_config(self, monkeypatch):
        """Test _setup_all_sso_mappings returns None for role mappings when no configuration is available"""
        import asyncio
        from unittest.mock import AsyncMock, MagicMock
