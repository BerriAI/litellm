...
_DAILY_USER_SPEND_DDL: Final = """
    CREATE TABLE "LiteLLM_DailyUserSpend" (
        ...
        autorouter_accounted_requests BIGINT NOT NULL DEFAULT 0,
        autorouter_requests BIGINT NOT NULL DEFAULT 0,
        autorouter_llm_spend DOUBLE PRECISION NOT NULL DEFAULT 0,
        autorouter_classifier_cost DOUBLE PRECISION NOT NULL DEFAULT 0,
        autorouter_classifier_cost_recorded_requests BIGINT NOT NULL DEFAULT 0,
        autorouter_estimated_requests BIGINT NOT NULL DEFAULT 0,
        autorouter_estimated_actual_spend DOUBLE PRECISION NOT NULL DEFAULT 0,
