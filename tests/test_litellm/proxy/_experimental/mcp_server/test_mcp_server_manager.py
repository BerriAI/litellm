...
class TestMCPServerManager:
    ...
    async def test_call_tool_without_broken_pipe_error(self):
        ...
        async def mock_call_tool(params, host_progress_callback=None, on_dispatch=None):
...
class _RetryFakeClient:
    ...
    async def call_tool(self, params, host_progress_callback=None, raise_on_error=False, on_dispatch=None):
        self.attempts += 1
