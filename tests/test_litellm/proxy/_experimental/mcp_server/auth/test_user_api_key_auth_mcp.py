        ...
        [
            ...
            (
                [
                    ...
                    (b"x-mcp-zapier-x-api-key", b"zapier-api-key"),
                ],
                "test-api-key-123",
                None,
                {"github": "Bearer github-token", "zapier": "zapier-api-key"},
            ),
            ...
            (
                [
                    ...
                    (b"x-mcp-custom-x-custom-header", b"custom-value"),
                ],
                "test-api-key-123",
                None,
                {"deepwiki": "Basic base64-encoded", "custom": "custom-value"},
            ),
