...
class TestPostgresStatementTimeoutOptions:
    ...
    def test_direct_url_is_never_bounded(self, tmp_path):
        ...
        config_path = tmp_path / "config.yaml"
        config_path.write_text(yaml.dump({"model_list": [], "general_settings": {"database_statement_timeout": 60}}))

        captured = self._run_server_and_capture_urls(str(config_path), direct_url="postgresql://t:t@localhost:5432/t")
