...
class TestGetAllFallbacks:
    """Test cases for get_all_fallbacks function."""
    ...
    def test_no_fallbacks_config_returns_empty_list(self):
    ...
    def test_model_with_fallbacks_returns_complete_list(self):
    ...
    def test_model_without_fallbacks_returns_empty_list(self):
    ...
    def test_general_fallback_type(self):
    ...
    def test_invalid_fallback_type_returns_empty_list(self):
    ...
    def test_multiple_fallbacks_complete_list(self):
    ...
    def test_wildcard_and_specific_fallbacks(self):
    ...
    def test_default_fallback_type_is_general(self):
