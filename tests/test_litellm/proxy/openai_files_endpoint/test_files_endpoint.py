...
def _get_file_size(file_content: Union[bytes, io.IOBase]) -> int:
    ...
    if isinstance(file_content, io.IOBase):
        ...
        return size
    return len(file_content)  # type: ignore[arg-type]
    ...
    class DummyManagedFiles(BaseFileEndpoints):
        async def acreate_file(
            ...
            return OpenAIFileObject(
                id="dummy-id",
                object="file",
                bytes=_get_file_size(file_data[1]) if file_data else 0,
