...
def test_string_cost_values():
    ...
    # Note: prompt_tokens must be >= sum of token details to avoid double-counting correction
    # text_tokens(700) + cached_tokens(200) + audio_tokens(100) + cache_creation_tokens(150) = 1150
    usage = Usage(
        prompt_tokens=1150,
