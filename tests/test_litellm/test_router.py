    ...
    def _complexity_router_params(default_model: str, tags=None) -> dict:
        return {
            ...
            "complexity_router_config": {
                "tiers": {"SIMPLE": "gpt-4o-mini", "MEDIUM": "gpt-4o", "COMPLEX": "gpt-4o", "REASONING": "gpt-4o-mini"}
            },
    ...
    def _router_with_hybrid_router(cls) -> "litellm.Router":
        return litellm.Router(
            model_list=[
                ...
                {
                    "model_name": "hybrid-router",
                    "litellm_params": cls._hybrid_router_params(
                        {"SIMPLE": "gpt-4o-mini", "MEDIUM": "gpt-4o", "COMPLEX": "gpt-4o", "REASONING": "gpt-4o"}
                    ),
                    "model_info": {"id": "router-1", "db_model": True},
                },
            ],
