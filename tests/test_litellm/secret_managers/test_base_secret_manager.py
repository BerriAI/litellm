"""
Test raise_if_unsafe_secret_name, the shared guard applied before any secret_name
(derived from user-controlled key_alias) reaches a secret manager backend.
"""
