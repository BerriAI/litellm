...
def test_writer_palmyra_routes_to_converse():
    ...
    bedrock_route = bedrock_model_info.get_bedrock_route(model="bedrock/writer.palmyra-x5-v1:0")
    assert bedrock_route == "converse"

    bedrock_route = bedrock_model_info.get_bedrock_route(model="bedrock/writer.palmyra-x4-v1:0")
    assert bedrock_route == "converse"
...
def test_writer_palmyra_cross_region_routes_to_converse():
    ...
    bedrock_route = bedrock_model_info.get_bedrock_route(model="bedrock/us.writer.palmyra-x5-v1:0")
    assert bedrock_route == "converse"

    bedrock_route = bedrock_model_info.get_bedrock_route(model="bedrock/us.writer.palmyra-x4-v1:0")
    assert bedrock_route == "converse"
...
def test_writer_palmyra_base_model_extraction():
    ...
    base_model = bedrock_model_info.get_base_model(model="bedrock/us.writer.palmyra-x5-v1:0")
    assert base_model == "writer.palmyra-x5-v1:0"

    base_model = bedrock_model_info.get_base_model(model="bedrock/us.writer.palmyra-x4-v1:0")
