...
async def test_ensure_initialize_azure_sdk_client_always_used(call_type):
    ...
    elif call_type == CallTypes.asearch or call_type == CallTypes.avector_store_search or call_type == CallTypes.avector_store_file_create or call_type == CallTypes.avector_store_file_list or call_type == CallTypes.avector_store_file_retrieve or call_type == CallTypes.avector_store_file_content or call_type == CallTypes.avector_store_file_update or call_type == CallTypes.avector_store_file_delete or call_type == CallTypes.avector_store_create:
        # Skip vector store and search operations as they don't use initialize_azure_sdk_client
        pytest.skip(f"Skipping {call_type.value} because Azure search/vector store operations don't use initialize_azure_sdk_client")
