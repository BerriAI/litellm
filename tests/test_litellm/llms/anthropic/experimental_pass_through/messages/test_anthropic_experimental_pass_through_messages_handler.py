...
async def test_bedrock_converse_budget_tokens_preserved():
    ...
    # NOTE: messages.acreate may not always use the passed-in client instance.
    # Patch the AsyncHTTPHandler.post method at the class level to ensure we intercept
    # the Bedrock Converse HTTP call.
    with patch(
