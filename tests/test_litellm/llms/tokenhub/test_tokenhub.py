...
class TestTokenHubConfig:
    def test_get_supported_params_with_reasoning_model(self):
        ...
        # deepseek-v4-pro is marked with supports_reasoning=true in model_prices JSON
...
class TestTokenHubProviderRouting:
    ...
    def test_provider_models_loaded(self):
        """Test tokenhub models are loaded from model_prices JSON."""
        import litellm

        assert len(litellm.tokenhub_models) > 0
        assert "tokenhub/deepseek-v4-pro" in litellm.tokenhub_models
