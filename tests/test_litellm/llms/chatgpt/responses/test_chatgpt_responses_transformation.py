...
class TestChatGPTResponsesAPITransformation:
    ...
    def test_chatgpt_non_stream_sse_response_parsing_empty_completed_output(self):
        config = ChatGPTResponsesAPIConfig()
        response_payload = {
            "id": "resp_test",
            "object": "response",
    ...
    def test_chatgpt_non_stream_sse_response_ignores_non_string_delta(self):
        config = ChatGPTResponsesAPIConfig()
        response_payload = {
            "id": "resp_test",
            "object": "response",
        ...
        sse_body = "\n".join(
            [
                f"data: {json.dumps({'type': 'response.output_text.delta', 'delta': 123})}",
