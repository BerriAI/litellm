...
def test_anthropic_adapter_content_filter_and_refusal():
    ...
    assert adapter._translate_openai_finish_reason_to_anthropic("content_filter") == "refusal"
    assert adapter._translate_openai_finish_reason_to_anthropic("refusal") == "refusal"
    ...
    anthropic_response = adapter.translate_openai_response_to_anthropic(openai_response)
