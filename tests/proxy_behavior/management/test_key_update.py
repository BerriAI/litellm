...
# a team admin may update a key in their own team even when another member
# owns it (200); every other (INTERNAL_USER-roled) actor hits user_id-mismatch
# 403, no-team-admin 403, or team_member_permission 401 depending on target /
# membership.
_SCENARIOS = [
