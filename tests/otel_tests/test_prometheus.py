...
async def test_proxy_failure_metrics():
    ...
    async with aiohttp.ClientSession() as session:
        ...
        assert (
            'litellm_proxy_total_requests_metric_total{api_key_alias="None",end_user="None",hashed_api_key="88dc28d0f030c55ed4ab77ed8faf098196cb1c05df778539800c9f1243fe6b4b",requested_model="fake-azure-endpoint",team="None",team_alias="None",user="default_user_id",status_code="429"} 1.0'
            in metrics
        )
