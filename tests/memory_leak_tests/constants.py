...
TEST_MASTER_KEY = "sk-1234"  # Master key for WITHOUT DB test (must equal TEST_API_KEY)
TEST_DIFFERENT_MASTER_KEY = "sk-different-master-key-for-db-test"  # Master key for WITH DB test (must NOT equal TEST_API_KEY)
