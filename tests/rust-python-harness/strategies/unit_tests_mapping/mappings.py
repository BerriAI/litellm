...
from ...shared.unit_runners.rust_runner import RustTarget, RustTestScope
...
def _rust_test(target: RustTarget, module: str, test: str) -> str:
    return f"{target.key}::{module}::{test}"
