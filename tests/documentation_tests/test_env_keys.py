...
EXCLUDED_BYTEPLUS_VARS = {
    "BYTEPLUS_API_BASE",
    "BYTEPLUS_API_KEY",
    "BYTEPLUS_TTS_ACCESS_KEY",
    "BYTEPLUS_TTS_API_BASE",
    "BYTEPLUS_TTS_APP_ID",
    "BYTEPLUS_TTS_APP_KEY",
}

EXCLUDED_KEYS = frozenset(
    EXCLUDED_TERMINAL_VARS | EXCLUDED_GUARD_ONLY_VARS | EXCLUDED_ROLLOUT_FLAGS | EXCLUDED_BYTEPLUS_VARS
)
