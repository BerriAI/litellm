...
async def test_increment_remaining_budget_metrics(prometheus_logger):
    ...
    litellm_params = {
        "metadata": {
            ...
            "user_api_key_team_budget_reset_at": future_reset_time_team.isoformat(),
            "user_api_key_budget_reset_at": future_reset_time_key.isoformat(),
        }
    }
    ...
    # The remaining hours should be approximately 12 (with some small difference due to test execution time)
