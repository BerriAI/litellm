...
class BaseGoogleGenAITest:
    ...
    def _validate_standard_logging_payload(self, slp: StandardLoggingPayload, response: Any):
        """
    ...
    async def test_async_non_streaming_with_logging(self):
        ...
        self._validate_standard_logging_payload(test_custom_logger.standard_logging_object, response)
    ...
    async def test_async_streaming_with_logging(self):
        ...
        self._validate_standard_logging_payload(test_custom_logger.standard_logging_object, chunks)
